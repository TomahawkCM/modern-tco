...
export const WIDGET_DEFINITIONS: WidgetDefinition[] = [
  ...
  {
    type: 'safe-to-spend',
    title: 'widget.safeToSpend.title',
    description: 'widget.safeToSpend.description',
    icon: 'ShieldCheck',
    defaultSize: 'medium',
    minSize: 'small',
    maxSize: 'large',
    requiresData: true,
    tags: ['budget', 'spending', 'analysis', 'popular'],
  },
  {
    type: 'streaks',
    title: 'widget.streaks.title',
    description: 'widget.streaks.description',
    icon: 'Flame',
    defaultSize: 'small',
    minSize: 'small',
    maxSize: 'medium',
    requiresData: false,
    tags: ['gamification', 'engagement', 'streaks'],
  },
  {
    type: 'weekly-recap',
    title: 'widget.weeklyRecap.title',
    description: 'widget.weeklyRecap.description',
    icon: 'CalendarDays',
    defaultSize: 'medium',
    minSize: 'small',
    maxSize: 'medium',
    requiresData: true,
    tags: ['spending', 'weekly', 'analysis'],
  },
  {
    type: 'net-worth-mini',
    title: 'widget.netWorthMini.title',
    description: 'widget.netWorthMini.description',
    icon: 'Landmark',
    defaultSize: 'small',
    minSize: 'small',
    maxSize: 'medium',
    requiresData: true,
    tags: ['net-worth', 'summary', 'wealth'],
  },
  {
    type: 'event-budget',
    title: 'widget.eventBudget.title',
    description: 'widget.eventBudget.description',
    icon: 'PartyPopper',
    defaultSize: 'small',
    minSize: 'small',
    maxSize: 'medium',
    requiresData: true,
    tags: ['events', 'budget', 'projects'],
  },
];
