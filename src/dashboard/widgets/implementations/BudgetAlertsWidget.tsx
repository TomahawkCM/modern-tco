...
import { detectOverspending, detectCurrentOverspending } from '@/lib/analytics/overspending-detector';
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs font-medium ${isDanger ? 'text-red-400' : 'text-amber-400'}`}>
                  ...
                  <div className="mt-1.5 flex justify-between text-xs text-slate-400">
                    <span>
                      {format.number(alert.currentSpent, { style: 'currency', currency })} / {format.number(alert.budgetAmount, { style: 'currency', currency })}
                    </span>
