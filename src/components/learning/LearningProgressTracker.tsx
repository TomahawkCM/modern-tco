              ...
              return (
                <Card
                  ...
                  className={cn(
                    ...
                    status.label === "Complete" && "border-green-200 bg-green-50"
                  )}
                >
                  <CardContent className="p-4">
                ...
                <Card
                  ...
                  className={cn(
                    ...
                    achievement.unlocked
                      ? "border-orange-200 bg-gradient-to-r from-yellow-50 to-orange-50"
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      {achievement.unlocked && <CheckCircle2 className="h-5 w-5 text-[#22c55e]" />}
                    </div>
                  </CardContent>
                </Card>
              ))}
