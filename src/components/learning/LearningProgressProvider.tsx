...
const LEARNING_DOMAINS: LearningDomain[] = [
  {
    ...
    description:
      'Build your IT foundation with endpoint management basics, terminology, and confidence-building exercises',
    estimatedTime: '2-4 hours',
    difficulty: 'Foundation',
    overallProgress: 0,
    modules: [
      {
        id: 'intro-to-it-security',
        title: 'Introduction to IT Security',
        domain: 'phase-0-foundation',
        order: 1,
        progress: 0,
        isCompleted: false,
      },
      {
        id: 'endpoint-management-basics',
  ...
  },
  {
    ...
    modules: [
      ...
      {
        id: 'saved-questions',
        title: 'Saved Question Management',
        domain: 'asking-questions',
        order: 3,
        progress: 0,
        isCompleted: false,
      ...
      {
        id: 'asking-questions-lab',
        title: 'Hands-On Lab: Query Construction',
        domain: 'asking-questions',
        order: 7,
        progress: 0,
        isCompleted: false,
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        title: 'Enterprise-Scale Targeting',
        domain: 'refining-questions',
        order: 6,
        progress: 0,
        isCompleted: false,
      },
      {
        ...
        title: 'Logical Operators & Boolean Logic',
        domain: 'refining-questions',
        order: 7,
        progress: 0,
        isCompleted: false,
      ...
      {
        id: 'refining-questions-lab',
        title: 'Hands-On Lab: Advanced Targeting',
        domain: 'refining-questions',
        order: 8,
        progress: 0,
        isCompleted: false,
    ...
    modules: [
      {
        ...
        title: 'Package Selection & Validation',
      ...
      {
        id: 'action-execution',
        title: 'Action Execution & Monitoring',
        domain: 'taking-action',
        order: 3,
        progress: 0,
        isCompleted: false,
      ...
      {
        id: 'taking-action-lab',
        title: 'Hands-On Lab: Safe Action Deployment',
        domain: 'taking-action',
        order: 7,
        progress: 0,
        isCompleted: false,
    ...
    modules: [
      {
        ...
        title: 'Console Navigation Mastery',
      ...
      {
        id: 'interact-module',
        title: 'Interact Module Operations',
        domain: 'navigation-modules',
        order: 2,
        progress: 0,
        isCompleted: false,
      ...
      {
        id: 'navigation-lab',
        title: 'Hands-On Lab: Platform Navigation',
        domain: 'navigation-modules',
        order: 8,
        progress: 0,
        isCompleted: false,
  ...
  },
  {
    ...
    modules: [
      ...
      {
        id: 'reporting-lab',
        title: 'Hands-On Lab: Report Creation & Export',
        domain: 'reporting-export',
        order: 7,
        progress: 0,
        isCompleted: false,
...
export function LearningProgressProvider({ children }: LearningProgressProviderProps) {
  ...
  const overallProgress = Math.round(
    domains.reduce((acc, domain) => {
      const domainProgress =
        domain.modules.reduce((modAcc, module) => modAcc + module.progress, 0) /
      ...
      prevDomains.map((domain) => ({
        ...
        overallProgress: Math.round(
          domain.modules.reduce(
            (acc, mod) => acc + (mod.id === moduleId ? progressPercent : mod.progress),
            0
          ) / domain.modules.length
        ),
      }))
  ...
  const getProgress = () => {
    ...
    const completedModules = domains.reduce(
      (acc, domain) => acc + domain.modules.filter((module) => module.isCompleted).length,
      0
    );
    const percentage = totalModules > 0 ? Math.round((completedModules / totalModules) * 100) : 0;
    const estimatedTime = domains.reduce(
      (acc, domain) =>
        acc + (domain.estimatedTime ? parseInt(domain.estimatedTime.split(' ')[0], 10) || 0 : 0),
      0
    );
