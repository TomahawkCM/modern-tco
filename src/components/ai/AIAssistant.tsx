  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
      <div className="fixed bottom-4 right-4 h-[600px] w-[400px] md:w-[500px]">
        <Card className="h-full border-cyan-200 bg-gradient-to-br from-cyan-50 to-cyan-100 backdrop-blur-md dark:border-cyan-800 dark:from-cyan-900/20 dark:to-cyan-800/20">
          <CardHeader className="border-b border-cyan-200 pb-3 dark:border-cyan-700/50">
          ...
          <CardContent className="flex flex-1 flex-col overflow-hidden p-0">
            ...
            <div className="flex-1 space-y-4 overflow-y-auto p-4">
              {messages.length === 0 && (
                <div className="py-8 text-center">
                  <Brain className="mx-auto mb-4 h-12 w-12 text-cyan-600 dark:text-primary" />
                  <h3 className="mb-2 text-lg font-semibold text-cyan-900 dark:text-cyan-100">
                    Welcome to your AI Study Assistant!
                  </h3>
                  <p className="mb-4 text-sm text-cyan-700 dark:text-primary">
                  ...
                  <div
                    className={cn(
                      ...
                      message.sender === "user"
                        ...
                        : "border border-cyan-200 bg-white/90 text-cyan-900 dark:border-cyan-700 dark:bg-cyan-950/50 dark:text-cyan-100"
                    )}
                  >
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="rounded-lg border border-cyan-200 bg-white/90 px-4 py-2 dark:border-cyan-700 dark:bg-cyan-950/50">
            ...
            {/* Input */}
            <div className="border-t border-cyan-200 p-4 dark:border-cyan-700/50">
              <form onSubmit={handleSubmit} className="flex gap-2">
                <Input
                  ...
                  className="flex-1 border-cyan-200 bg-white/90 text-cyan-900 placeholder-cyan-600 dark:border-cyan-700 dark:bg-cyan-950/50 dark:text-cyan-100 dark:placeholder-cyan-400"
                  disabled={isLoading}
                />
                <Button
                  type="submit"
