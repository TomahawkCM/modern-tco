      ...
      <div className="fixed bottom-4 right-4 h-[600px] w-[400px] md:w-[500px]">
        <Card className="h-full border-cyan-200 bg-gradient-to-br from-cyan-50 to-cyan-100 dark:border-cyan-800 dark:from-cyan-900/20 dark:to-cyan-800/20 backdrop-blur-md">
          <CardHeader className="pb-3 border-b border-cyan-200 dark:border-cyan-700/50">
            ...
            {moduleSlug && (
              <Badge variant="outline" className="w-fit border-cyan-300 bg-cyan-100 text-cyan-700 dark:border-cyan-600 dark:bg-cyan-900/30 dark:text-cyan-300">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 && (
                <div className="text-center py-8">
                  <Brain className="h-12 w-12 mx-auto mb-4 text-cyan-600 dark:text-cyan-400" />
                    ...
                    {quickActions.map((action) => {
                      ...
                      return (
                        <Button
                          ...
                          className="flex items-center gap-2 border-cyan-300 text-cyan-700 hover:bg-cyan-100 dark:border-cyan-600 dark:text-cyan-300 dark:hover:bg-cyan-900/30"
                        >
