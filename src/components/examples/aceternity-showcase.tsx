    ...
    <div className="relative min-h-screen bg-black">
      ...
      <section className="relative z-10 pb-16 pt-20">
        <div className="container mx-auto px-4 text-center">
          <div>
            <h1 className="mb-8 text-4xl font-bold text-foreground md:text-6xl">
        ...
        <div className="container mx-auto px-4">
          ...
          <CardContainer className="inter-var mx-auto max-w-md">
            <CardBody className="group/card relative h-auto w-auto rounded-xl border border-black/[0.1] bg-gray-50 p-6 dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] sm:w-[350px]">
              <CardItem
                translateZ="50"
                className="text-xl font-bold text-neutral-600 dark:text-foreground"
              >
                TCO Certification
              </CardItem>
              <CardItem
              ...
              <CardItem translateZ="100" className="mt-4 w-full">
                <div className="flex h-60 w-full items-center justify-center rounded-xl bg-gradient-to-br from-primary to-cyan-600">
              ...
              <div className="mt-20 flex items-center justify-between">
                <CardItem
                  translateZ={20}
                  className="rounded-xl px-4 py-2 text-xs font-normal dark:text-foreground"
                >
                  Start Learning →
                </CardItem>
                <CardItem
                  translateZ={20}
                  className="rounded-xl bg-black px-4 py-2 text-xs font-bold text-foreground dark:bg-white dark:text-black"
                >
                  Begin Study
                </CardItem>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="relative mx-auto max-w-md">
            ...
            <div className="relative flex h-full flex-col items-start justify-end overflow-hidden rounded-2xl border border-gray-800 bg-gray-900 px-4 py-8 shadow-xl">
              ...
              <h1 className="relative z-50 mb-4 text-xl font-bold text-foreground">
              ...
              <button className="rounded-lg border border-gray-500 px-4 py-1 text-muted-foreground">
                Explore Features
              </button>
              <Meteors number={20} />
            </div>
