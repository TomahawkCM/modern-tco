            ...
            <Toggle
              ...
              onPressedChange={(v) =>
                setSelectedStatuses((prev) =>
                  v ? Array.from(new Set([...prev, st])) : prev.filter((x) => x !== st)
                )
              }
              className="data-[state=on]:bg-primary/20 data-[state=on]:text-primary"
            >
