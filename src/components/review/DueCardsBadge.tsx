        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Link href="/review">
              <Button
                variant="ghost"
                size="sm"
                className={cn('relative gap-2 h-9', className)}
                aria-label={`${totalDue} items due for review`}
              >
                <Clock className={cn('h-4 w-4', isUrgent && 'text-orange-500 animate-pulse')} />
          ...
          <TooltipContent side="bottom" className="p-3">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground pt-1">Click to start reviewing</p>
            </div>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
