    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <span
            className={cn("mr-2 text-slate-400", isSeniorsMode ? "text-base" : "text-sm")}
            id="view-mode-label"
          >
            View:
          </span>
          ...
          >
            <button
              ...
              className={cn(
                ...
                isSeniorsMode && "px-4 py-2 text-base"
              )}
              role="radio"
        ...
        {viewMode === "chart" && (
          <button
            ...
            className={cn(
              "flex items-center gap-2 rounded-lg px-3 py-1.5 text-slate-400 transition-colors hover:bg-white/10 hover:text-white",
              isSeniorsMode && "px-4 py-2 text-base"
            )}
      ...
      <AnimatePresence mode="wait">
        {viewMode === "chart" ? (
          <motion.div
            ...
            aria-hidden={false}
          >
            <SankeyDiagram data={data} width={width} height={height} onNodeClick={onNodeClick} />
          </motion.div>
        ) : (
          <motion.div
            key="table"
      ...
      <p
        className={cn("mt-4 text-center text-slate-500", isSeniorsMode ? "text-sm" : "text-xs")}
        aria-hidden="true"
      >
        {viewMode === "chart"
