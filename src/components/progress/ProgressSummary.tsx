...
import { Trophy, Target, Clock, TrendingUp, Zap, Calendar, Award, BookOpen } from "lucide-react";
import {
      ...
      <Card className="border-accent/20 bg-gradient-to-br from-purple-500/5 to-blue-500/5">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center">
            ...
            <div className={`mb-2 text-6xl font-bold ${getReadinessColor(summary.examReadiness)}`}>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
              ...
              <div className="mt-1 text-xs text-muted-foreground">hours invested</div>
            </div>
            ...
            <div className="rounded-lg border border-accent/20 bg-accent/5 p-4">
              ...
              <div className="mt-1 text-xs text-muted-foreground">Level {summary.currentLevel}</div>
            </div>
          ...
          {summary.examReadiness >= 85 && (
            <div className="rounded-lg border border-[#22c55e]/30 bg-[#22c55e]/10 p-4 text-center">
              <Award className="mx-auto mb-2 h-8 w-8 text-[#22c55e]" />
              <p className="mb-1 text-sm font-semibold text-[#22c55e]">
