    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-4">
        <Card className="glass border-white/10">
          ...
          <CardContent>
            <div className="mb-2 text-2xl font-bold text-foreground">{foundationProgress}%</div>
            <Progress value={foundationProgress} className="mb-2 h-2" />
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <CardTitle className="text-lg text-foreground">Foundation</CardTitle>
                ...
                <Badge
                  ...
                  className={
                    hasCompletedFoundation ? "border-green-400 text-[#22c55e]" : "bg-blue-600"
                  }
                >
                  Step 1
                </Badge>
          ...
          {/* Hands-On Labs */}
          <Card className="glass cursor-pointer border-white/10 opacity-50 transition-all hover:border-white/20">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <CardTitle className="text-lg text-foreground">Hands-On Labs</CardTitle>
                    <p className="text-sm text-muted-foreground">Real Tanium scenarios</p>
                  </div>
                </div>
                <Badge variant="outline" className="border-cyan-400 text-primary">
                  Step 3
                </Badge>
              </div>
            </CardHeader>
        ...
        <Card className="glass border-white/10">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-pink-500/30 bg-gradient-to-r from-pink-500/20 to-primary/20 p-4">
