...
import type { FilterBuilderProps, FilterSelection, FilterOperator } from "./types/queryBuilder";
...
function FilterGroup({
  ...
  return (
    <div className={`space-y-2 ${depth > 0 ? "border-l-2 border-gray-700 pl-8" : ""}`}>
      {/* Group header */}
      {depth > 0 && (
        <div className="mb-2 flex items-center space-x-2">
          ...
          >
            <SelectTrigger className="h-6 w-20 border-gray-600 bg-gray-700">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
          ...
          {groupFilters
            ...
            .map((filter, index) => (
              <div key={filter.id} className="flex items-start space-x-2">
                ...
                {/* Filter row */}
                <div
                  className={`flex flex-1 items-start space-x-2 rounded border border-gray-700 bg-card p-2 ${index === 0 ? "" : "ml-12"}`}
                >
                  {/* Sensor selector */}
                  <Select
                    value={filter.sensor}
                  ...
                  >
                    <SelectTrigger className="w-48 border-gray-600 bg-gray-700">
                  ...
                  {filter.dataType === "boolean" ? (
                    ...
                    >
                      <SelectTrigger className="flex-1 border-gray-600 bg-gray-700">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                    ...
                    <Input
                      ...
                      className="flex-1 border-gray-600 bg-gray-700 text-foreground"
                    />
                  )}
        ...
        <div className="flex items-center justify-between">
          ...
          {filters.length > 1 && (
            <div className="flex items-center space-x-2">
              ...
              >
                <SelectTrigger className="h-8 w-20 border-gray-600 bg-gray-700">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="AND">AND</SelectItem>
      ...
      <CardContent>
        {filters.length === 0 ? (
          <div className="py-8 text-center text-muted-foreground">
            <Filter className="mx-auto mb-3 h-12 w-12 opacity-50" />
            <p>No filters applied</p>
            <p className="mt-1 text-sm">Add filters to narrow down results</p>
            <Button
              size="sm"
              variant="outline"
              onClick={() => {
