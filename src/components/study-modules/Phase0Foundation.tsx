...
export default function Phase0Foundation({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4 text-center">
        ...
        <div className="mx-auto max-w-md">
          ...
          <div className="h-3 w-full rounded-full bg-gray-200">
            <motion.div
              className="h-3 rounded-full bg-gradient-to-r from-primary to-sky-600"
              initial={{ width: 0 }}
            ...
            <div className="p-6">
              ...
              <div className="mb-4 flex items-start space-x-4">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    {module.isCompleted && <CheckCircle className="h-5 w-5 text-[#22c55e]" />}
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span
                      className={`rounded-full px-2 py-1 text-xs font-semibold ${getDifficultyColor(module.difficulty)}`}
                    >
                      {module.difficulty}
                    </span>
                  </div>
              ...
              <div className="mb-4 space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900">{getModuleProgress(module)}%</span>
                </div>
              ...
              <motion.button
                ...
                className="flex w-full items-center justify-center space-x-2 rounded-lg bg-gradient-to-r from-primary to-sky-600 px-4 py-3 font-semibold text-foreground transition-colors hover:from-cyan-600 hover:to-sky-700"
              >
              ...
              {activeModule === module.id && (
                ...
                >
                  <div className="space-y-4 p-6">
                    {module.sections.map((section) => (
                      <div key={section.id} className="space-y-3 rounded-lg bg-white p-4">
                        <div className="flex items-center justify-between">
                          ...
                          {completedSections.includes(section.id) ? (
                            ...
                            <motion.button
                              ...
                              className="rounded-full bg-primary px-3 py-1 text-xs text-foreground transition-colors hover:bg-blue-600"
                            >
                              Complete
                            </motion.button>
                          )}
      ...
      <div className="rounded-xl bg-gradient-to-r from-cyan-50 to-sky-50 p-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {foundationMilestones.map((milestone) => (
            <motion.div
              ...
              className={`space-y-2 rounded-lg border p-4 text-center ${
                milestone.isCompleted
                  ? "border-yellow-500 bg-gradient-to-r from-[#f97316] to-orange-400 text-foreground"
            ...
            >
              ...
              {milestone.isCompleted && (
                <div className="rounded-full bg-white/20 px-2 py-1 text-xs">{milestone.reward}</div>
              )}
            </motion.div>
          ))}
        </div>
        ...
        {showMilestone && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md space-y-6 rounded-2xl bg-white p-8 text-center"
            >
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
                className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-r from-[#f97316] to-orange-400"
              >
                <showMilestone.icon className="h-10 w-10 text-foreground" />
              </motion.div>
              ...
              <div className="rounded-lg bg-gradient-to-r from-cyan-50 to-sky-50 p-4">
      ...
      {overallProgress >= 100 && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 p-8 text-center text-foreground"
        >
          <Heart className="mx-auto mb-4 h-12 w-12" />
          <h2 className="mb-2 text-3xl font-bold">🎉 Foundation Complete!</h2>
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="rounded-xl bg-white px-8 py-4 font-bold text-[#22c55e] transition-colors hover:bg-green-50"
          >
