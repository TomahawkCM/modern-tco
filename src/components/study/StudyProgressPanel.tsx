    ...
    <Card className="border-primary/30 bg-gradient-to-b from-gray-900/50 to-blue-900/30">
      <CardHeader className="pb-3">
        ...
        <div className="mt-3 flex flex-col gap-2">
          <Button
            size="sm"
            className="h-8 w-full bg-green-700 text-xs hover:bg-[#22c55e]"
          ...
          <Button
            size="sm"
            variant="outline"
            className="h-8 w-full border-yellow-600 text-xs text-[#f97316] hover:bg-[#f97316]/10"
          ...
          <Button
            size="sm"
            variant="outline"
            className="h-8 w-full border-gray-600 text-xs text-muted-foreground hover:bg-gray-900/30"
        ...
        {lastViewed && (
          <div className="mt-3">
            <Button
              size="sm"
              className="h-8 w-full bg-cyan-700 text-xs hover:bg-primary"
            ...
            >
              ...
              <button
                className={cn(
                  ...
                  activeId === s.id ? "font-medium text-primary" : "text-blue-100"
                )}
