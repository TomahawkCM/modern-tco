      ...
      <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl">
        ...
        <div className="border-b-2 border-gray-200 p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="p-2 min-h-[48px] min-w-[48px] flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
          ...
          {/* Current Selection */}
          <div className="mt-4 flex items-center gap-3 rounded-lg bg-teal-50 p-4 border-2 border-teal-200">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-4 py-3 min-h-[48px] text-base border-2 border-gray-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20"
            />
          </div>
          {searchQuery && (
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3">
              {filteredIcons.map(({ name, Icon }) => (
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-3 rounded-lg transition-all min-h-[80px] hover:bg-gray-100 ${
                    value === name
                ...
                >
                  <Icon className={`h-8 w-8 ${value === name ? 'text-teal-600' : 'text-gray-600'}`} />
        ...
        <div className="border-t-2 border-gray-200 p-6 bg-gray-50">
          <div className="flex items-center justify-between gap-4">
            <p className="text-sm text-gray-600">
              {BUDGET_ICONS.length} icons available
            </p>
            <Button
              onClick={onClose}
              variant="outline"
