          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-0.5 text-xs text-slate-400">
                <span>{scenario.totalMonths} {t('months')}</span>
                <span>{formatCurrency(scenario.totalInterest)} {t('interest')}</span>
                <span>{debtFreeDate.toLocaleDateString(undefined, { year: 'numeric', month: 'short' })}</span>
              </div>
            </div>
            <Button
              variant="ghost"
