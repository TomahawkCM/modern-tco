  ...
  return (
    <div className="space-y-3 text-sm">
      ...
      <div className="flex justify-between items-center">
        ...
        <span className="font-mono font-medium">{formatCurrency(sampleCurrency, currency, locale)}</span>
      </div>
      ...
      {locale === 'en-IN' && (
        <div className="mt-4 pt-4 border-t">
          <div className="text-xs text-muted-foreground mb-2">Indian Numbering System:</div>
          <div className="flex justify-between items-center">
