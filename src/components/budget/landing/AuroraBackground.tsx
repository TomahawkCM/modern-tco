  ...
  return (
    <div className={cn("pointer-events-none absolute inset-0 -z-10 overflow-hidden", className)}>
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(20,184,166,0.55), rgba(20,184,166,0))",
        }}
        animate={{
          x: [0, 40, -10, 0],
          y: [0, 25, -15, 0],
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(236,72,153,0.18), rgba(236,72,153,0))",
        }}
        animate={{ x: [0, 20, -20, 0] }}
      ...
      {/* Vignette */}
      <div className="absolute inset-0 [mask-image:radial-gradient(70%_60%_at_50%_35%,black,transparent)] bg-black/60" />
    </div>
  );
}
