          ...
          {content.faq.map((item) => (
            <LandingCard key={item.q} className="px-5 py-4">
              <details className="group open:bg-transparent">
                <summary className="cursor-pointer select-none list-none rounded-xl text-base font-semibold text-white outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950">
