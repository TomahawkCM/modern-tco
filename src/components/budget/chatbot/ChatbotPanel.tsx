  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-6 right-6 z-[999] h-[calc(100vh-80px)] max-h-[600px] w-full sm:w-[400px] flex flex-col rounded-lg border border-gray-200 bg-white shadow-2xl"
        style={{
