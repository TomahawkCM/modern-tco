...
export const ChatbotMessages: React.FC<ChatbotMessagesProps> = ({ messages, isTyping }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden scroll-smooth p-4"
      role="log"
      aria-live="polite"
      aria-atomic="false"
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-4 py-12 text-center">
            ...
            <div className="max-w-xs space-y-2">
              <h3 className="text-lg font-semibold text-gray-900">Welcome to Budget Assistant!</h3>
              <p className="text-sm text-gray-600">
                I can help you understand your finances, manage transactions, and get insights on
                your spending.
              </p>
