...
export const CyberpunkCard: React.FC<CyberpunkCardProps> = ({ 
  ...
  const baseClasses = "relative bg-black/20 backdrop-blur-xl border border-cyan-500/20 rounded-xl"
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-[1px] bg-gradient-to-r from-cyan-500 via-sky-400 to-cyan-500 rounded-xl opacity-20 blur-sm animate-pulse"></div>
