...
import { Activity, Bell, Cpu, Search, Shield, User, Zap } from 'lucide-react';
...
export const CyberpunkNavBar: React.FC<CyberpunkNavBarProps> = ({
  ...
  if (!mounted) {
    return (
      <nav
        className={`fixed top-0 left-0 right-0 z-50 bg-white/[0.02] backdrop-blur-xl backdrop-saturate-150 border-b border-white/10 shadow-lg shadow-black/5 ${className}`}
      >
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <img src="/tco-logo.png" alt="TCO Logo" className="w-10 h-10 object-contain" />
              <div className="text-xl font-bold text-primary">{brandName}</div>
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
              ...
              >
                ...
                <div className="relative w-9 h-9 bg-white/[0.05] backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center">
                  ...
                  <span
                    className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full text-[10px] text-foreground flex items-center justify-center font-bold"
                    aria-hidden="true"
                  >
                    3
                  </span>
