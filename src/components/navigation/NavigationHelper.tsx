...
export default function NavigationHelper({
  ...
  }, [pathname, visitedPaths, navigationTips]);
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1">
                        {currentTip.tips.map((tip, index) => (
                          <li
                            key={index}
                            className="text-sm text-cyan-200/80 flex items-start space-x-2"
                          >
                ...
                <div className="space-y-2">
                  {learningJourney.map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-foreground"
                          style={{
                            background: isPast
                              ? 'rgba(34, 211, 238, 0.8)'
                              : isCurrent
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-primary/70 mt-1">{step.description}</p>
                        </div>

                        {isCurrent && (
                          <span
                            className="px-2 py-1 text-xs text-foreground rounded-full font-semibold"
                            style={{
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-cyan-200/90">
                      ...
                      <span
                        className="inline-flex items-center mx-1 px-1 py-0.5 rounded text-xs"
                        style={{
          ...
          >
            ...
            >
              <div className="text-center space-y-4">
                ...
                >
                  <h3 className="text-sm font-semibold text-cyan-100 mb-2">Your First Steps:</h3>
