      ...
      {examDate && (
        <div className="text-center p-4 bg-[#22c55e]/10 border border-[#22c55e]/20 rounded-lg">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            {Math.ceil((examDate.getTime() - Date.now()) / (1000 * 60 * 60 * 24))} days until your
            exam
          </p>
        </div>
      )}
    ...
    <div className="space-y-6 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
        <div className="p-4 rounded-lg border border-primary/20 bg-primary/5">
          <div className="text-2xl font-bold text-primary mb-1">Study Daily</div>
          <div className="text-xs text-muted-foreground">Build a consistent review habit</div>
        </div>
        <div className="p-4 rounded-lg border border-accent/20 bg-accent/5">
          <div className="text-2xl font-bold text-accent-foreground mb-1">Trust the System</div>
        ...
        <div className="p-4 rounded-lg border border-[#22c55e]/20 bg-[#22c55e]/5">
          <div className="text-2xl font-bold text-[#22c55e] mb-1">Track Progress</div>
