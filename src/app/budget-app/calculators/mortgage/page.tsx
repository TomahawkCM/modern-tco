...
import { generateAmortizationSchedule, calculateAffordability } from "@/lib/financial-engine";
import { formatCurrency } from "@/i18n/utils/formatCurrency";
import type { SupportedLocale } from "@/i18n/config";
import { LOCALE_METADATA } from "@/i18n/config";
import { cn } from "@/lib/utils";

const MortgageChart = lazy(() =>
...
export default function MortgageCalculatorPage() {
  ...
  // Sample chart data (every 12th month for performance)
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-slate-400">{t("mortgage.subtitle")}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6 rounded-xl border border-slate-700 bg-slate-800/50 p-6">
          <h2 className="text-lg font-semibold text-white">{t("mortgage.inputTitle")}</h2>
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-6">
          ...
          {paymentResult.schedule.length > 12 && (
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-slate-600 py-2 text-sm text-slate-400 transition-colors hover:bg-slate-700"
            >
