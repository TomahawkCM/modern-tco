...
const EXAMPLE_QUERIES = [
  ...
  },
  {
    ...
    difficulty: 2,
    question:
      'Get Computer Name and CPU Percent from all machines where Operating System contains "Windows" and Computer Role equals "Workstation" and CPU Percent is greater than "65" order by CPU Percent desc limit 5',
  },
  {
    id: "rq-laptops-group",
    ...
    difficulty: 2,
    question:
      'Get Computer Name, Disk Free GB, Memory GB from group "Laptops" order by Disk Free GB',
  },
  {
    id: "rd-avg-disk",
...
export const GET = withErrorTracking(
  async () => {
    try {
      ...
      throw new ApiError("Unable to read simulator metadata", 500, "METADATA_READ_FAILED");
    }
  },
  { endpoint: "/api/sim-meta" }
);
