...
export default function QueryBuilderPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-foreground mb-2">Tanium Query Builder</h1>
      ...
      <Alert className="mb-6 border-blue-500 bg-primary/10">
        ...
        <AlertDescription className="text-primary">
          <strong>Interactive Learning Mode:</strong> This simulator helps you understand Tanium's
          natural language query system. Practice building queries using guided mode, natural
          language, or advanced syntax.
        </AlertDescription>
      </Alert>
