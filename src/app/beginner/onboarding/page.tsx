      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10">
        <header className="rounded-3xl border border-cyan-900/40 bg-gradient-to-br from-gray-950 via-gray-950 to-cyan-950/40 p-8 text-left shadow-xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="max-w-3xl space-y-4">
              <Badge className="w-fit border-cyan-600/40 bg-cyan-900/40 text-cyan-100">Start here</Badge>
              <h1 className="text-3xl font-bold text-white md:text-4xl">Welcome to your Tanium beginner path</h1>
              <p className="text-lg text-cyan-100/90">
                In less than ten minutes you will know exactly how this course is organised, the language we use, and how to earn your first win inside the Tanium console.
              </p>
            </div>
        ...
        <section aria-labelledby="why-overview" className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 id="why-overview" className="text-2xl font-semibold text-white">What to expect from the course</h2>
          </div>
        ...
        <section aria-labelledby="first-success" className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 id="first-success" className="text-2xl font-semibold text-white">Your "first success" path (about 12 minutes)</h2>
          </div>
          <ol className="space-y-4 rounded-lg border border-[#22c55e]/30 bg-[#22c55e]/10 p-6 text-white/90">
            <li>
              ...
              <p className="text-sm text-white/80">
                Learn how Tanium thinks about endpoints using the city-wide radio analogy. Video placeholder will live here.
              </p>
            ...
            <li>
              ...
              <p className="text-sm text-white/80">
                See where to click: Interact → Question Builder → Ask Question. Screenshots slot into the gallery component below.
              </p>
            ...
            <li>
              ...
              <p className="text-sm text-white/80">
                Ask "Get Computer Name from all machines" and celebrate the instant response stream. Module 00 Step 2 walks through each click.
              </p>
            </li>
            <li>
              <h3 className="text-lg font-semibold">4. Reinforce with two flashcards</h3>
              <p className="text-sm text-white/80">
                Jump into the spaced-repetition deck tagged <strong>foundation</strong> and review the vocabulary you just saw.
              </p>
            </li>
          </ol>
        </section>
        ...
        <section aria-labelledby="glossary" className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 id="glossary" className="text-2xl font-semibold text-white">Glossary cheat sheet</h2>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
            {[{
              term: "Endpoint",
              definition: "Any computer, server, or device Tanium manages. Think of it as a citizen listening to the city-wide radio.",
            },
            {
              term: "Sensor",
              definition: "A question template that asks endpoints for live data. Sensors collect, they never change things.",
            },
            {
              term: "Package",
              definition: "A checklist of actions Tanium can run on endpoints—install software, clean temp files, update settings.",
            },
            {
              term: "Action",
          ...
          <Card className="border-cyan-500/40 bg-cyan-950/30">
            ...
            <CardContent>
              <p className="text-sm text-cyan-100/90">
                Prefer audio? Quick definitions are available as 30-second clips inside the Module 00 flashcard deck. Screen reader users can jump straight to the <strong>Glossary</strong> heading in Module 00.
              </p>
            </CardContent>
          </Card>
        </section>
        ...
        <section aria-labelledby="next-steps" className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 id="next-steps" className="text-2xl font-semibold text-white">Next steps (save this checklist)</h2>
          </div>
          <Card className="border-white/10 bg-white/5 backdrop-blur-sm">
            <CardContent className="space-y-3 p-6 text-sm text-muted-foreground">
              <ul className="list-disc space-y-2 pl-6">
                <li>Bookmark this page or download the PDF (coming soon) so you always have the glossary and step-by-step guide.</li>
                <li>Set a reminder to return tomorrow—Module 00 is designed for two short sittings.</li>
