...
export default function MockExamPage() {
  ...
  const handleStartExam = () => {
    void analytics.capture("mock_exam_start", {
      duration: defaultConfig.duration,
      questions: defaultConfig.questionCount,
    });
      ...
      <div className="glass-card border-tanium-orange/20 p-6">
        ...
        <Alert className="border-tanium-orange/30 bg-tanium-orange/10">
          ...
          <AlertDescription className="text-foreground">
            <strong>Exam Simulation:</strong> This mock exam replicates the actual TCO certification
            exam format, timing, and difficulty level.
          </AlertDescription>
        </Alert>
      </div>
