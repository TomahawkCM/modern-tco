...
export const BUDGET_ACHIEVEMENTS: Omit<BudgetAchievement, "unlockedAt">[] = [
  // Budgeting
  {
    id: "budget_keeper_1",
    name: "Budget Keeper",
    description: "Under budget for 1 month",
    icon: "shield",
    category: "budgeting",
    requirement: { type: "months_under_budget", value: 1 },
    points: 50,
    rarity: "common",
  },
  {
    ...
    icon: "shield-check",
    category: "budgeting",
    requirement: { type: "months_under_budget", value: 3 },
    points: 150,
    rarity: "uncommon",
  },
  {
    id: "budget_keeper_6",
    name: "Budget Master",
    description: "Under budget for 6 consecutive months",
    icon: "shield-alert",
    category: "budgeting",
    requirement: { type: "months_under_budget", value: 6 },
    points: 500,
    rarity: "rare",
  },
  {
    id: "budget_keeper_12",
    name: "Budget Legend",
    description: "Under budget for 12 consecutive months",
    icon: "crown",
    category: "budgeting",
    requirement: { type: "months_under_budget", value: 12 },
    points: 1500,
    rarity: "legendary",
  },
  ...
  // Saving
  {
    id: "saver_star",
    name: "Saver Star",
    description: "Savings rate above 20% for a month",
    icon: "star",
    category: "saving",
    requirement: { type: "savings_rate", value: 20 },
    points: 100,
    rarity: "uncommon",
  },
  ...
  // Debt
  {
    ...
    icon: "trophy",
    category: "debt",
    requirement: { type: "loans_paid_off", value: 1 },
    points: 500,
    rarity: "rare",
  },
  ...
  // Receipt scanning
  {
    ...
    icon: "camera",
    category: "receipt",
    requirement: { type: "receipts_scanned", value: 10 },
    points: 50,
    rarity: "common",
  },
  {
    ...
    icon: "scan",
    category: "receipt",
    requirement: { type: "receipts_scanned", value: 50 },
    points: 200,
    rarity: "uncommon",
  },
  {
    ...
    icon: "scan-line",
    category: "receipt",
    requirement: { type: "receipts_scanned", value: 100 },
    points: 500,
    rarity: "rare",
  },
  ...
  // No-spend days
  {
    ...
    icon: "wallet",
    category: "saving",
    requirement: { type: "no_spend_days", value: 7 },
    points: 150,
    rarity: "uncommon",
  },
  ...
  // Import
  {
    id: "import_master",
    name: "Import Master",
    description: "Imported from 3+ file formats",
    icon: "file-input",
    category: "import",
    requirement: { type: "import_formats", value: 3 },
    points: 200,
    rarity: "uncommon",
  },
];
...
export async function calculateStreak(): Promise<BudgetStreak> {
  const events = await db.gamificationState.orderBy("timestamp").reverse().toArray();
...
export function calculateTotalPoints(): number {
  const unlockedIds = getUnlockedAchievementIds();
  return BUDGET_ACHIEVEMENTS.filter((a) => unlockedIds.has(a.id)).reduce(
    (sum, a) => sum + a.points,
    0
  );
}
