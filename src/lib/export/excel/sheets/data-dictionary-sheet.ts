...
const DATA_DICTIONARY: DataDictionaryEntry[] = [
  // Dashboard
  {
    ...
    dataType: "Currency",
    example: "$125,430.00",
    notes: "Updates with each export",
  },
  {
    sheet: "Dashboard",
    column: "Monthly Income",
    description: "Sum of all income transactions for current month",
    dataType: "Currency",
    example: "$8,500.00",
  },
  {
  ...
  },
  {
    ...
    description: "Raw description from bank statement",
    dataType: "Text",
    example: "SQ *STARBUCKS #12345",
  },
  {
    sheet: "Transactions",
    column: "Category",
  ...
  },
  {
    sheet: "Transactions",
    column: "Amount",
    description: "Transaction amount (negative = expense)",
    dataType: "Currency",
    example: "-$5.75",
    notes: "Red for expenses, green for income",
  },
  {
    sheet: "Transactions",
    column: "Running Balance",
    description: "Cumulative balance after transaction",
    dataType: "Currency",
    example: "$2,340.25",
    notes: "Calculated chronologically",
  },
  {
    sheet: "Transactions",
    column: "Month",
    description: "Year-month for pivot table grouping",
    dataType: "Text",
    example: "2026-01",
  },
  {
    sheet: "Transactions",
    column: "Day of Week",
    description: "Day name for spending pattern analysis",
    dataType: "Text",
    example: "Monday",
  },
  {
    sheet: "Transactions",
    column: "Recurring",
    description: "Whether transaction repeats regularly",
    dataType: "Boolean",
    example: "Yes/No",
  },
  {
  ...
  // Monthly Summary
  {
    ...
    column: "Month",
    description: "Month being summarized",
    dataType: "Text",
    example: "Jan 2026",
  },
  {
  ...
  {
    sheet: "Monthly Summary",
    column: "vs Prev Month",
    description: "Change in Net from previous month",
    dataType: "Currency",
    example: "+$400.00",
  },
  {
  ...
  },
  {
    sheet: "Monthly Summary",
    column: "Trend",
    description: "Visual trend indicator",
    dataType: "Symbol",
    example: "▲ ▼ ─",
  },
  ...
  },
  {
    sheet: "Category Analysis",
    column: "Remaining",
    description: "Budget minus Actual",
    dataType: "Currency",
    example: "-$120.00",
    notes: "Negative = over budget",
  },
  {
    sheet: "Category Analysis",
    column: "% Used",
  ...
  },
  {
    ...
    description: "Date balance was last verified",
    dataType: "Date",
    example: "2026-01-10",
  },
  ...
  },
  {
    ...
    description: "Allocated monthly amount",
    dataType: "Currency",
    example: "$2,000.00",
  },
  {
    sheet: "Budgets",
    column: "[Month] Actual",
    description: "Actual spending for month",
    dataType: "Currency",
    example: "$1,800.00",
  },
  {
    sheet: "Budgets",
    column: "[Month] Var",
    description: "Budget minus Actual (positive = under)",
    dataType: "Currency",
    example: "+$200.00",
  },
  {
    sheet: "Budgets",
    column: "YTD Budget",
    description: "Year-to-date budget total",
    dataType: "Currency",
    example: "$12,000.00",
  },
  {
  ...
  },
  {
    sheet: "Budgets",
    column: "YTD Var",
    description: "YTD Budget minus YTD Actual",
    dataType: "Currency",
    example: "+$1,200.00",
  },
  {
    sheet: "Budgets",
    column: "Progress",
    description: "Visual YTD progress",
    dataType: "Text",
    example: "████████░░",
  },
  ...
  },
  {
    ...
    dataType: "Text",
    example: "Active/Paused/Cancelled",
  },
  {
    sheet: "Subscriptions",
    column: "Category",
  ...
  // Loans
  {
    sheet: "Loans",
    column: "Loan Name",
    description: "User-defined loan name",
    dataType: "Text",
    example: "Car Loan",
  },
  {
    ...
    dataType: "Text",
    example: "Mortgage/Auto/Personal/Student",
  },
  {
    sheet: "Loans",
    column: "Original",
  ...
  },
  {
    sheet: "Loans",
    column: "Remaining Mo.",
    description: "Months until payoff",
    dataType: "Number",
    example: "41",
  },
  {
    sheet: "Loans",
    column: "Total Interest",
    description: "Remaining interest to be paid",
    dataType: "Currency",
    example: "$3,200.00",
  },
  {
  ...
  },
  {
    ...
    description: "Account type",
    dataType: "Text",
    example: "RRSP/TFSA/Non-registered",
  },
  {
    sheet: "Investments",
    column: "Symbol",
  ...
  },
  {
    sheet: "Investments",
    column: "Market Value",
    description: "Shares × Current Price",
    dataType: "Currency",
    example: "$4,925.00",
  },
  {
    sheet: "Investments",
    column: "Gain/Loss",
    description: "Market Value minus Cost Basis",
    dataType: "Currency",
    example: "+$425.00",
  },
  {
    sheet: "Investments",
    column: "Gain %",
    description: "Gain/Loss as percentage",
    dataType: "Percentage",
    example: "+9.4%",
  },
  ...
  },
  {
    sheet: "Goals",
    column: "On Track?",
    description: "Whether current pace meets target",
    dataType: "Text",
    example: "✓ Yes / ⚠ Behind",
  },
  {
