...
export async function decryptTransaction(transaction: any): Promise<any> {
  ...
  if (
    decrypted.amount &&
    typeof decrypted.amount === "string" &&
    decrypted.amount.startsWith("encrypted:")
  ) {
  ...
  if (
    ...
    typeof decrypted.description === "string" &&
    decrypted.description.startsWith("encrypted:")
  ) {
  ...
  if (
    decrypted.notes &&
    typeof decrypted.notes === "string" &&
    decrypted.notes.startsWith("encrypted:")
  ) {
  ...
  if (
    decrypted.merchant &&
    typeof decrypted.merchant === "string" &&
    decrypted.merchant.startsWith("encrypted:")
  ) {
...
export async function decryptAccount(account: any): Promise<any> {
  ...
  if (
    ...
    decrypted.name.startsWith("encrypted:")
  ) {
  ...
  if (
    ...
    typeof decrypted.accountNumber === "string" &&
    decrypted.accountNumber.startsWith("encrypted:")
  ) {
    decrypted.accountNumber = await decryptValue(decrypted.accountNumber);
  }

  if (
    decrypted.institution &&
    typeof decrypted.institution === "string" &&
    decrypted.institution.startsWith("encrypted:")
  ) {
