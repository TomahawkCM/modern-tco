...
export function transformYNABCategories(
  ...
  const existingCategoryMap = buildExistingCategoryMap(
...
function buildExistingCategoryMap(
  categories: Category[]
): Map<string, Category> {
...
function createCategory(
  ...
  const isArchived =
    group.hidden && options.hiddenCategoryAction === 'archive';
 ...
 */
export function quickTransformCategories(
  data: ParsedYNABData
): CategoryTransformResult {
