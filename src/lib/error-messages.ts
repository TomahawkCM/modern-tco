...
export const ErrorMessages = {
  ...
  noAnswerSelected: {
    title: "No answer yet!",
    message: "Hmm, looks like you haven't picked an answer yet! Give it a shot - even if you're not sure, taking a guess helps with learning. 🤔",
  ...
  flashcardCreationFailed: {
    ...
    message: "Oops! We had trouble saving that flashcard. This usually happens if there's a connection hiccup.",
  ...
  flashcardsLoadFailed: {
    ...
    message: "We're having trouble loading your flashcards right now. This could be a temporary connection issue.",
  ...
  noFlashcardsDue: {
    ...
    message: "Great work! You don't have any flashcards due for review right now. Check back later, or create some new ones from your learning materials. 🎉",
  ...
  queryEmpty: {
    ...
    message: "Hmm, you'll need to add at least one sensor (what to ask about) before running the query. Think of sensors as the questions you want to ask your computers!",
  ...
  queryExecutionFailed: {
    ...
    message: "We hit a snag trying to run your query. This might be a temporary issue with the demo environment.",
  ...
  emailInvalid: {
    ...
    message: "Hmm, that doesn't look like a complete email address. Make sure it has an @ symbol and a domain (like .com or .edu).",
  ...
  passwordComplexityFailed: {
    ...
    message: "For security, your password needs at least 8 characters with a mix of uppercase letters, lowercase letters, and numbers. Think of it like creating a secret code! 🔐",
    action: "Make sure your password has all three: uppercase (A-Z), lowercase (a-z), and numbers (0-9)",
    variant: 'warning' as const,
  },

  passwordMismatch: {
    title: "Passwords don't match",
    message: "The two passwords you entered are different. This happens to everyone - typos are sneaky!",
  ...
  loginFailed: {
    ...
    message: "We couldn't log you in with those credentials. Double-check your email and password - typos happen to everyone!",
  ...
  sessionExpired: {
    ...
    message: "For security, we automatically log you out after a period of inactivity. No worries - just log back in to continue!",
  ...
  networkError: {
    ...
    message: "We're having trouble connecting right now. Check your internet connection, or if you're online, our servers might be taking a quick break.",
  ...
  timeoutError: {
    ...
    message: "That took longer than expected and timed out. This sometimes happens with slow connections or if the server is busy.",
  ...
  genericError: {
    ...
    message: "We ran into an unexpected issue. This doesn't usually happen! The technical details have been logged.",
...
export function humanizeError(error: unknown): HelpfulErrorMessage {
  if (error instanceof Error) {
    ...
    const isUserFriendly = !error.message.includes('undefined') &&
