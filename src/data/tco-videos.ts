...
export const tcoVideos: TCOVideo[] = [
  // Navigation and Basic Module Functions (23% exam weight)
  {
    ...
    description:
      "Learn to navigate the Tanium console, understand module functions, and master the basic interface components essential for TCO certification.",
  ...
  },
  {
    ...
    description:
      "Master the single endpoint view feature for efficient help desk operations. Learn to access detailed endpoint information, manage offline data, create custom panels, and take actions directly on endpoints. Covers endpoint overview, management, investigation, and customization for your specific needs.",
  ...
  // Asking Questions (22% exam weight)
  {
    ...
    description:
      "Master the art of asking effective questions using Tanium's natural language interface. Learn question construction, sensor usage, and best practices.",
  ...
  },
  {
    ...
    description:
      "Advanced techniques for creating complex questions, using parameters, and managing your question library effectively.",
  ...
  // Taking Action (15% exam weight)
  {
    ...
    description:
      "Learn the basics of package deployment and action execution for TCO certification. Covers simple deployment workflows and monitoring.",
  ...
  // Refining Questions (23% exam weight)
  {
    ...
    description:
      "Master computer groups, basic filtering techniques, and targeting strategies essential for TCO certification.",
  ...
  // Reporting and Data Export (17% exam weight)
  {
    ...
    description:
      "Learn fundamental reporting techniques, data export methods, and basic Connect integration for TCO certification.",
  ...
  // SecuritySenses TCO Certification Series
  {
    ...
    description:
      "Comprehensive TCO exam preparation by experts who helped write the exam questions. Insider guidance and best practices.",
  ...
  // Additional TCO Practice Videos
  {
    ...
    description:
      "Hands-on practice scenarios covering all TCO domains with guided solutions and explanations.",
