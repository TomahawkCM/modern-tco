...
This is a completely clean PowerShell script with no markdown or documentation mixed in. The issue was that the file contained markdown documentation text which PowerShell couldn't parse.
...
This will execute the TypeScript testing without any parser errors.
