...
export const generatedQuestions: Question[] = [
  {
    "question": "As an IT security analyst, you've been tasked with generating a weekly report on all detected malware incidents across your organization's endpoints. This report should include timestamps, endpoint names, and incident details. You need to automate this report to be sent to the security team every Monday. Which Tanium module will you use to accomplish this?",
    "choices": [
      {
        "id": "a",
  ...
  },
  {
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Connect with an XML template is correct because it allows for the configuration of data exports in specific formats, including XML, which meets the requirement for ITSM tool integration. Choice A (Trends) is incorrect because it's primarily for internal visualization, not for external data export. Choice C (Asset) is incorrect because, while it provides inventory data, it doesn't support custom export formats like XML directly. Choice D (Deploy) is incorrect because it's used for executing actions, not exporting data in specific formats.",
    "tags": [
      "connect-module",
      "xml-export",
      "itsm-integration",
  ...
  {
    "question": "You are configuring Tanium to send alerts to your organization's SIEM system whenever unauthorized software is detected on any endpoint. Which Tanium module would best facilitate the real-time alerting and integration with external SIEM systems?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are tasked with automating the export of weekly vulnerability scan results from Tanium to a CSV file for analysis by your compliance team. Which approach allows you to meet this requirement most efficiently?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A security analyst wants to share a custom report on recent endpoint security incidents with external consultants without giving them direct access to Tanium. What is the best way to regularly provide them with this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your company requires all endpoint data exported from Tanium for analysis to be in JSON format to integrate with a custom analytics platform. Which module should you configure to ensure compatibility?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To comply with internal data retention policies, you are tasked with configuring Tanium to archive all reports older than six months. Which strategy will effectively automate this process?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to visualize endpoint compliance status over time to identify trends and potential security gaps. Which module and feature should you leverage for this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your executive team requests a monthly report on the operational health and compliance of all endpoints, including out-of-compliance devices, to be integrated into the company's executive dashboard. Which Tanium module would best automate and facilitate this integration?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In planning for an upcoming security audit, you need to ensure that all exported reports from Tanium regarding endpoint vulnerabilities are available in XML format for the auditors' tools. Which Tanium feature should you configure to meet this requirement?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Configuring the Connect module to export vulnerability reports in XML format directly meets the requirement for the security audit, ensuring compatibility with the auditors' tools. Choice A (Interact) does not inherently provide XML export functionality. Choice C (Trends) involves unnecessary manual steps. Choice D (Deploy) is not designed for report generation or export, particularly in specific formats like XML.",
    "tags": [
      "data-export-formats",
      "connect-integration",
  ...
  {
    "question": "After integrating Tanium with your company's IT service management (ITSM) system using Connect, you notice that not all incident tickets are being created for detected issues. What is the first step you should take to troubleshoot this issue?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are configuring a new report template in Tanium for endpoint security compliance that will be distributed company-wide. To ensure the report is easily accessible and understandable by all recipients, what is an essential feature to include?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires the setup of a new Connect destination to send endpoint security state information to a SIEM system for real-time analysis. What key consideration should you prioritize to ensure the integration's success?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are tasked with creating a weekly report that shows all unpatched vulnerabilities across your networked devices. The report must be shared with your IT security team every Monday morning. Which Tanium module and feature should you use to automate this task?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your company requires weekly exports of endpoint health metrics to be analyzed in an external business intelligence tool. The data must be in CSV format. Which Tanium feature should you configure to meet this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization needs to automate the distribution of compliance reports to a third-party auditor every quarter. The reports should include detailed system configurations and compliance statuses in XML format. Which solution within Tanium would best accomplish this?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Setting up Connect destinations to email the XML reports is correct because Connect allows for the automated distribution of reports in specific formats, including XML, and can be scheduled to send these reports directly to third-party emails, such as an auditor. Choice A (Configuring email alerts within the Trends module) is incorrect because Trends primarily focuses on data visualization and alerting based on trends, not on exporting detailed reports. Choice B (Using the Interact module to manually send the reports) is incorrect because it relies on manual processes and does not support automated scheduling or XML format exports. Choice D (Automating reports through the Protect module) is incorrect because Protect is focused on security compliance and threat protection, not on the automated distribution of reports in XML format.",
    "tags": [
      "connect-destinations",
      "report-sharing-and-distribution",
      "xml-export",
  ...
  {
    "question": "To improve incident response times, you need to configure Tanium to send real-time alerts to your SIEM whenever a new unmanaged device is detected on the network. Which Tanium module facilitates this integration?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After a recent audit, you're required to demonstrate how long endpoint data is retained within Tanium for compliance purposes. Which module and feature should you consult to find this information?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are preparing a presentation for the executive team on the effectiveness of the newly deployed endpoint protection solution. Which Tanium module should you use to create visual reports that highlight key metrics and trends?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To streamline IT operations, your team decides to integrate Tanium data with your IT service management (ITSM) platform to automatically create tickets based on specific Tanium alerts. Which Tanium feature is best suited for this task?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization demands a weekly security report that includes all new software installations on endpoints within the last 7 days. This report should be automatically emailed to the security team. Which Tanium solution will fulfill this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To comply with industry regulations, your organization must archive all endpoint activity data for a minimum of five years. Which Tanium feature allows you to configure long-term data retention policies?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In an effort to enhance security analysis, your team decides to export detailed endpoint threat data to a third-party analytics platform. The data should be exported in JSON format for compatibility. Which Tanium module and setup will achieve this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "As part of your compliance reporting, you're tasked with automating the export of weekly security audit results to a CSV file for further analysis. Which Tanium module would streamline this process?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Connect is correct because it is designed to automate data exports in various formats, including CSV, and can be scheduled to run reports on a recurring basis. Choice A (Interact) is incorrect because it's mainly for real-time data queries and does not support automated scheduling. Choice B (Trends) is incorrect because it focuses on data visualization within Tanium, not exporting data. Choice D (Asset) is incorrect because it's used for inventory management and not for exporting compliance reports.",
    "tags": [
      "connect-module",
      "csv-export",
      "automated-reports",
  ...
  {
    "question": "Your organization requires a daily export of endpoint vulnerability data to be integrated with your external ITSM system for ticketing. Which Connect destination configuration should be used for this integration?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To comply with regulatory standards, your team must archive all compliance report exports for a minimum of five years. Which feature should you consider to ensure data retention for this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to share weekly endpoint health reports with non-technical stakeholders in an easy-to-digest format. What is the best approach to meet this requirement?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Use Connect to send reports via email in PDF format is correct because it allows for the creation of visually appealing and digestible reports suitable for non-technical stakeholders and supports scheduling and automatic emailing. Choice A (Export data in XML format for technical accuracy) is incorrect because XML is a data-centric format that is not user-friendly for non-technical audiences. Choice C (Schedule SQL queries to run and export data to IT) is incorrect because it requires additional steps to convert data into a non-technical format. Choice D (Visualize data in Trends and grant dashboard access) is incorrect because, while visually appealing, it might require stakeholders to interact with the system directly, which could be challenging for non-technical users.",
    "tags": [
      "connect-module",
      "report-sharing",
      "pdf-reports",
  ...
  {
    "question": "To enhance security operations, your company wants to automatically export detected malware events from Tanium to a SIEM system in real-time. Which module and configuration should you use?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are tasked with configuring scheduled exports of network activity logs to an external database for long-term analysis and compliance. Which configuration in Tanium Connect should you prioritize to ensure data integrity during transfer?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your management team requests a monthly report that combines endpoint hardware, software inventory, and vulnerability status into a single comprehensive view. Which Tanium feature should you leverage to create and distribute this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparing for a security audit, you need to ensure that all endpoint security reports are distributed to the audit team in a secure and accessible format. What is the best method to accomplish this using Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "The IT department requires a custom dashboard that displays real-time data on patch compliance and software vulnerabilities across the network. Which Tanium module would you use to design this dashboard?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to automate the distribution of monthly device compliance reports to specific department heads within your organization. The report should include device compliance status, recent vulnerabilities found, and patch application success rates. Which solution within Tanium would you use to accomplish this task?",
    "choices": [
      {
        "id": "a",
