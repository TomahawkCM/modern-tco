...
export const generatedQuestions: Question[] = [
  {
    "question": "You're setting up a dashboard for a new security analyst who needs to monitor endpoint compliance and security posture regularly. Which Tanium module allows you to create and customize this dashboard?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to export detailed endpoint hardware and software data to a centralized IT asset management system every day. Which Tanium module is best suited for automating this data export?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A compliance officer requires a monthly report on the patch status of all endpoints across the organization. Which Tanium module should you use to automate the generation and delivery of this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization is implementing a new policy requiring all endpoints to have the latest antivirus definitions. You need to verify compliance across 10,000 endpoints. Which Tanium module would you use to perform this check?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You have been asked to ensure that all users can only access modules relevant to their roles. What is the first step in configuring module access control within the Tanium Console?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires a daily export of endpoint security logs to a third-party analytics platform for advanced analysis. Which Tanium module should be configured to automate this process?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After a recent security breach, your CISO wants to enhance the visibility of real-time endpoint data across the network to detect threats faster. Which Tanium module will provide the necessary capabilities to meet this requirement?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Interact module is correct because it provides the capability to ask questions and receive real-time data from endpoints across the network, which is essential for rapid threat detection. Choice A (Asset) is incorrect because, while it manages endpoint inventory, it does not focus on real-time data collection. Choice C (Trends) is incorrect because it visualizes data over time rather than providing real-time analysis. Choice D (Reporting) is incorrect because it generates reports based on historical data, not real-time monitoring.",
    "tags": [
      "interact-module",
      "real-time-data",
      "threat-detection",
  ...
  {
    "question": "In preparation for an upcoming audit, your team needs to demonstrate the ability to quickly identify and report on non-compliant endpoints within the network. Which Tanium module will best facilitate this task?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization is transitioning to a hybrid work model, and you're tasked with configuring Tanium to monitor both on-premise and remote endpoints effectively. Which module should you prioritize for configuring to ensure continuous visibility?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to ensure that the executive team can view monthly security performance metrics without accessing the full Tanium Console. Which module allows you to configure custom views that can be securely shared with non-Tanium users?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "As an IT administrator, you need to customize the Tanium dashboard to highlight critical security alerts and system health metrics for a quick overview. Which Tanium module allows you to personalize the dashboard view according to these needs?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are tasked with exporting historical endpoint data to create compliance reports for an audit. The reports need to illustrate trends over the past year. Which module in Tanium should you use to gather and visualize this data?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A new compliance requirement mandates that all endpoint security settings be regularly reported and analyzed for gaps. Which Tanium module would you configure to schedule and automate these security reports?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To enhance operational efficiency, your organization seeks to automate the export of Tanium data to a third-party business intelligence tool. Which module would be most effective for automating this data export process?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "The security team wants to ensure that only users with specific roles can access sensitive data collected by Tanium. Which area of the Tanium console should you configure to manage these access controls?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to quickly identify which endpoints are running an outdated version of a critical software to address a recent security vulnerability. Which Tanium module would you use to perform this task efficiently?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires a monthly analysis of patch compliance trends to improve security posture. Which Tanium module will provide the best capabilities for visualizing these trends over time?",
    "choices": [
      {
        "id": "a",
        "text": "Trends module for visualizing data over time"
  ...
  {
    "question": "To ensure effective incident response, your organization intends to streamline the process of exporting Tanium data to your incident response platform. Which module facilitates the seamless integration and export of Tanium data to external platforms?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are configuring the Tanium console for a new team of security analysts. They need quick access to view endpoint security configurations and vulnerability statuses across the network. Which module should you emphasize for this purpose?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Interact is correct because it allows security analysts to quickly query real-time data about endpoint security configurations and vulnerability statuses, providing immediate insights necessary for security assessments. Choice A (Deploy) is incorrect as it's intended for managing security configurations, not for querying data. Choice C (Asset) is incorrect because, although it provides a comprehensive inventory, it does not specialize in the real-time querying of security configurations. Choice D (Trends) is incorrect as it focuses on historical data analysis, not real-time data access.",
    "tags": [
      "interact-module",
      "real-time-data",
      "endpoint-security",
  ...
  {
    "question": "Following a directive to improve data sharing between Tanium and your organization's ticketing system, you are tasked with setting up a process to automatically create tickets based on specific Tanium alerts. Which module will you use to automate this integration?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Connect is correct because it enables the automation of data workflows between Tanium and external systems, like a ticketing system, allowing for automatic ticket creation based on specific alerts. Choice B (Deploy) is incorrect as it's focused on managing and executing actions on endpoints, not data integration. Choice C (Interact) is incorrect because it's used for querying data and obtaining information on alerts, not for automating workflows. Choice D (Trends) is incorrect as it provides analysis on data trends over time, not direct integration capabilities.",
    "tags": [
      "connect-module",
      "data-automation",
  ...
  {
    "question": "As a new IT analyst, you're tasked with customizing the Tanium dashboard to better monitor security compliance across your network. You want to add widgets that display real-time data on patch management and antivirus status. Which module allows you to customize the dashboard with these widgets?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Trends is correct because it allows the creation and customization of dashboards using widgets that can visualize both historical and real-time data, suitable for monitoring security compliance. Choice A (Deploy) is incorrect as it's primarily for executing actions, not dashboard customization. Choice B (Interact) is incorrect because, although it queries real-time data, it doesn't support dashboard customization. Choice D (Connect) is incorrect because its main function is data export and integration, not dashboard visualization.",
    "tags": [
      "dashboard-customization",
      "trends-module",
      "real-time-data",
  ...
  {
    "question": "Your manager asks you to configure a system that automatically sends endpoint security status reports to the compliance team every Friday. Which Tanium module should you utilize to schedule and automate these reports?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "While reviewing your organization's security posture, you realize the need to export real-time threat intelligence data to your external threat analysis tool. Which Tanium module would best facilitate this continuous data export?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To improve operational efficiency, your team decides to monitor the performance of all deployed applications across the enterprise network. You need to visualize application performance trends over the last quarter. Which Tanium module should you leverage for this task?",
    "choices": [
      {
        "id": "a",
  ...
  },
  {
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Trends is correct because it is the best fit for visualizing application performance data over time, which is crucial for ensuring minimal disruption during the migration. Choice A (Asset) is incorrect as it's more focused on inventory management than performance monitoring. Choice C (Deploy) is incorrect since its primary function is deploying software, not monitoring performance. Choice D (Connect) is incorrect because, while it can export data for external monitoring, it lacks the internal visualization capabilities of Trends.",
    "tags": [
      "trends-module",
  ...
  {
    "question": "After implementing a new security policy, your team needs to ensure that all endpoints are in compliance. You want to generate a report detailing the current compliance status of each endpoint and schedule it for monthly review meetings. Which Tanium module would be most appropriate for this task?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Comply is correct because it offers compliance assessment features and the capability to generate and schedule compliance reports, fitting the need to monitor endpoints for policy compliance. Choice A (Connect) is incorrect as it focuses on data export, not compliance reporting. Choice C (Deploy) is incorrect because it's used for software distribution and configuration management, not compliance assessment. Choice D (Interact) is incorrect as it's intended for real-time querying, not for generating scheduled reports.",
    "tags": [
      "comply-module",
      "compliance-reporting",
      "security-policy",
  ...
  {
    "question": "You're configuring Tanium to improve your organization's operational awareness. You need a module that lets team members view endpoint health, user activity, and security alerts in a customizable interface. Which module best supports creating such a comprehensive operations dashboard?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Trends is correct because it allows users to create customizable dashboards that can display a wide range of operational data, including endpoint health, user activity, and security alerts. Choice B (Interact) is incorrect because, while it can provide detailed endpoint data, it does not offer dashboard customization. Choice C (Asset) is incorrect as it focuses on inventory management rather than operational awareness. Choice D (Connect) is incorrect because its primary function is data integration, not dashboard creation.",
    "tags": [
      "trends-module",
  ...
  {
    "question": "Your company is enhancing its endpoint security measures. As part of this initiative, you are tasked with periodically reviewing all installed software across endpoints to identify and remediate unauthorized applications. Which Tanium module would be most effective for this continuous monitoring and management?",
    "choices": [
      {
        "id": "a",
  ...
  },
  {
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Comply is correct because it provides the tools for assessing the compliance of endpoints against security standards and generating reports on their status, which is essential for preparing for security audits. Choice A (Protect) is incorrect because it focuses on protecting endpoints from threats, not on compliance reporting. Choice C (Deploy) is incorrect as it's used for changing configurations, not for compliance assessment. Choice D (Interact) is incorrect since it's used for querying endpoints in real-time, not for comprehensive compliance assessment and reporting.",
    "tags": [
      "comply-module",
      "security-audit",
  ...
  {
    "question": "As a new Tanium operator, you're tasked with customizing the dashboard to include widgets that show the status of critical vulnerabilities across the network. Which module allows you to customize the dashboard with this specific data visualization?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You have been asked to export a list of all installed software on endpoints to a CSV file for audit purposes. Which Tanium module will you use to accomplish this task without requiring any external system integration?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your manager requests a monthly report showing the compliance status of all endpoints against the company's security baseline. Which module should you configure to automatically generate and send this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're configuring access permissions for a new team member in the Tanium console. The member needs to query endpoints for real-time data but should not have the ability to execute actions. Which module permissions should you assign to them?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After deploying Tanium to a new region, you notice that some endpoints are not reporting as expected. To troubleshoot, you decide to check the connection status of these endpoints from the Tanium console. Which module should you use to view the current connection status?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're planning to integrate Tanium data with your company's business intelligence (BI) tools to analyze endpoint security trends over time. Which module would be most appropriate for setting up this integration?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for an upcoming security audit, you need to ensure that you can provide historical data on endpoint security posture changes over the past year. Which module would be most effective for gathering this historical data?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your company is enforcing a new policy where all endpoints must have a specific software installed. You need to check which endpoints do not comply with this policy. Which Tanium module will provide you with this capability?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've been tasked with reducing the time spent by your team on manual data gathering for compliance reports. Which Tanium module would best automate this process, allowing for scheduled data collection and report generation?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are configuring the Tanium console for a group of new users who will only need to view reports and dashboards without the capability to make changes. Which user interface element should you focus on to restrict their access appropriately?",
    "choices": [
      {
        "id": "a",
