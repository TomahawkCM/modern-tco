...
export const generatedQuestions: Question[] = [
  {
    question:
      'As part of your new security policy, you need to generate a weekly report summarizing the health status and compliance of all endpoints. Which Tanium module will you use to automate this process?',
    choices: [
      {
        id: 'a',
    ...
    explanation:
      "The Reporting module is correct because it allows users to create, customize, and schedule reports for automatic generation, fitting the need for weekly compliance and health status summaries. Choice A (Deploy) is incorrect because it is used to execute actions, not generate reports. Choice B (Interact) is incorrect because, while it can query health status, it doesn't schedule reports. Choice D (Connect) is incorrect because its primary function is to export data to external systems, not schedule reports.",
    tags: ['reporting-module', 'scheduled-reports', 'compliance', 'endpoint-health'],
    id: 'NAVIGA-GEN-1760811201094-1',
  },
  {
    question:
      'Your team needs to quickly assess the impact of a newly announced vulnerability across all endpoints. You must determine which endpoints are affected within minutes. Which Tanium module should you primarily rely on?',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    category: 'Practical Scenarios',
    explanation:
      "Deploy is correct because it not only allows for querying endpoint states but also for executing actions, such as installing or updating software to enforce compliance with approved versions. Choice A (Asset) is incorrect because, while useful for inventory, it doesn't enforce changes. Choice C (Interact) is incorrect as it can query installed versions but not perform updates. Choice D (Connect) is incorrect because its purpose is to export data, not update software.",
    tags: ['deploy-module', 'software-compliance', 'corrective-actions', 'version-enforcement'],
    id: 'NAVIGA-GEN-1760811201094-3',
  },
  {
    question:
      'After configuring a new dashboard in the Trends module to monitor endpoint health metrics, you want to share this view with team leads across departments. What is the most efficient method to provide access?',
    choices: [
      {
        id: 'a',
    ...
    tags: ['trends-module', 'dashboard-sharing', 'user-permissions', 'access-management'],
    id: 'NAVIGA-GEN-1760811201094-4',
  },
  {
    question:
      'You need to automate the export of Tanium gathered data to a third-party analytics platform every day at midnight to improve your continuous monitoring capabilities. Which Tanium module is best suited for this task?',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    tags: ['trends-module', 'dashboard-customization', 'endpoint-monitoring', 'data-visualization'],
    id: 'NAVIGA-GEN-1760820636171-1',
  },
  {
    question:
      "You're configuring a scheduled report that sends daily summaries of endpoint security compliance to your management team. Which Tanium module should you use to automate this reporting?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Reporting is correct because it enables the creation, customization, and scheduling of reports to be sent out automatically, which is ideal for daily summaries of security compliance. Choice A (Connect) is incorrect because it primarily deals with exporting data to external systems. Choice C (Trends) is incorrect because, while it does analyze data over time, it doesn't specialize in sending reports. Choice D (Interact) is incorrect because it's used for real-time queries, not for automated reporting.",
    tags: ['reporting-module', 'scheduled-reports', 'security-compliance', 'automation'],
    id: 'NAVIGA-GEN-1760820636171-2',
  },
  {
    question:
      'Your team needs to frequently modify user roles to reflect changes in responsibilities. Which area of the Tanium console should you navigate to in order to adjust these module permissions and access?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      'Tanium Console settings under Administration is correct because this area allows administrators to manage user roles, permissions, and access to various modules, accommodating changes in team responsibilities. Choice A (Interact module settings) is incorrect because it only pertains to configurations within the Interact module itself. Choice C (Deploy module configuration) is incorrect as it deals with settings specific to software deployment. Choice D (Connect module access controls) is incorrect because it focuses on permissions within the Connect module only.',
    tags: ['console-settings', 'user-roles', 'module-permissions', 'administration'],
    id: 'NAVIGA-GEN-1760820636171-3',
  },
  {
    question:
      'A security analyst needs to quickly find endpoints running an outdated version of a critical software. Which Tanium module facilitates the fastest retrieval of this information?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Interact is correct because it provides the capability to ask real-time questions across endpoints to quickly identify those running outdated software. Choice B (Asset) is incorrect because, though it provides inventory information, it may not offer the immediacy of Interact. Choice C (Connect) is incorrect because its primary function is data export, not live querying. Choice D (Deploy) is incorrect because it's focused on software distribution and management, not on querying endpoint status.",
    tags: ['interact-module', 'real-time-queries', 'software-inventory', 'endpoint-analysis'],
    id: 'NAVIGA-GEN-1760820636171-4',
  },
  {
    question:
      'To implement a new compliance policy, you need to ensure continuous monitoring and reporting on the use of unauthorized software across the network. Which Tanium module best supports setting up this compliance monitoring?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'The IT department wants to export the results of specific Tanium queries to a third-party analytics platform for further analysis. Which Tanium module should be used to configure the data export?',
    choices: [
      {
        id: 'a',
    ...
    tags: ['connect-module', 'data-export', 'third-party-analytics', 'query-results'],
    id: 'NAVIGA-GEN-1760820636171-6',
  },
  {
    question:
      'After a major security incident, your team is tasked with creating a dashboard that visualizes the spread of the incident across endpoints over time. Which module would you primarily use to achieve this visualization?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      "You need to periodically review and adjust the configurations of various Tanium modules to ensure they align with your organization's changing security policies. Which area of the Tanium console allows you to manage these settings for each module?",
    choices: [
      {
        id: 'a',
        text: 'Tanium Console settings under Administration',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Module settings through each module's configuration page is correct because it directly allows administrators to adjust settings specific to each Tanium module, matching organizational needs. Choice A (Tanium Console settings under Administration) is incorrect because it primarily manages console-wide settings, not specific module configurations. Choice C (Interact) is incorrect because it is a module for executing queries, not for configuring module settings. Choice D (Reporting) is incorrect because it generates reports on module utilization, not configuration management.",
    tags: ['module-settings', 'security-policies', 'configuration-management', 'module-adjustment'],
    id: 'NAVIGA-GEN-1760820636171-8',
  },
  {
    question:
      "To enhance your security team's efficiency, you decide to automate the export of detected malware events from Tanium to your incident response platform. Which module allows for the automation of this data export process?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      'Connect is correct because it is designed for creating and managing automated workflows for data export, including the integration with incident response platforms. Choice A (Deploy) is incorrect because it focuses on software deployment, not data export. Choice C (Trends) is incorrect because it is used for visualizing trends over time, not for automating exports. Choice D (Reporting) is incorrect because, although it can generate reports, it does not automate the export process.',
    tags: [
      'connect-module',
  ...
  {
    question:
      'Your organization requires a detailed analysis of historical endpoint data to identify trends in hardware usage and forecast future needs. Which Tanium module should you utilize to gather and analyze this historical data?',
    choices: [
      {
        id: 'a',
    ...
    tags: ['trends-module', 'historical-data-analysis', 'hardware-usage-trends', 'forecasting'],
    id: 'NAVIGA-GEN-1760820636171-10',
  },
  {
    question:
      "As a new Tanium administrator, you're tasked with customizing the dashboard to show only the most critical security metrics for your organization. Which module allows you to personalize the dashboard with widgets for quick views of these metrics?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Trends is correct because it allows administrators to create customizable dashboards with widgets that can visualize historical and real-time security metrics. Choice A (Interact) is incorrect because it's primarily used for ad-hoc querying, not dashboard customization. Choice C (Deploy) is incorrect because its focus is on deploying actions and configurations, not data visualization. Choice D (Connect) is incorrect because it's designed for exporting data to external systems, not for dashboard personalization.",
    tags: [
  ...
  {
    question:
      'You need to automate the process of exporting Tanium detected malware incidents to an external ticketing system for immediate action. Which Tanium module would best facilitate this automated export?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'Your organization requires a weekly report of all endpoints without the latest antivirus signatures to comply with internal security policies. Which Tanium module should you use to schedule and generate these reports?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'You have been asked to ensure that only members of the security team can view data within the Connect module. Which area of the Tanium Console should you configure to restrict module access?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      'Tanium Roles is correct because roles in Tanium define the permissions and access levels for users, enabling administrators to restrict module access to specific teams or individuals. Choice B (Module Settings) is incorrect because while module settings allow configuration of module behavior, they do not control user access. Choice C (User Groups) is involved in organizing users but does not directly grant module permissions. Choice D (Console Preferences) adjusts individual user interface settings, not access controls.',
    tags: [
      'module-permissions',
      'tanium-roles',
      'security-team',
  ...
  {
    question:
      "To optimize your organization's response to critical vulnerabilities, you need to create a dashboard that visualizes endpoint compliance over time. Which Tanium module will best support creating this dashboard?",
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'While preparing for an upcoming security audit, you are asked to provide a historical analysis of patch installations across your endpoint environment for the last six months. Which module offers the functionality to gather and visualize this type of historical data?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'Your team needs to quickly assess the impact of a newly discovered vulnerability across all endpoints. Which module allows you to construct a query to find out which endpoints are affected in real-time?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'In order to maintain operational security, your organization requires a regular export of Tanium data to a secure, centralized logging service. This process must be automated to ensure timely updates. Which Tanium module is best suited for setting up this automated data export?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      'Connect is correct because it enables administrators to set up automated exports of Tanium data to external systems, such as centralized logging services, ensuring data is continuously and automatically updated. Choice A (Trends) is incorrect because it focuses on internal data analysis, not external data sharing. Choice C (Reporting) is incorrect because it primarily deals with manual or scheduled report creation, not real-time automated data export. Choice D (Interact) is incorrect because, while it can perform real-time data queries, it does not automate data exports.',
    tags: [
      'connect-module',
      'automated-exporting',
  ...
  {
    question:
      "After deploying a critical application update across your organization's endpoints, you need to verify successful installation and gather compliance data. Which Tanium module allows you to efficiently track the status of this deployment?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Deploy is correct because it not only allows you to execute deployment actions but also provides tracking and reporting features to verify installation and compliance. Choice A (Connect) is incorrect as it's focused on exporting data rather than tracking deployments. Choice C (Trends) is incorrect because, although it visualizes compliance, it doesn't directly track specific deployment statuses. Choice D (Interact) provides real-time querying capabilities but lacks the structured tracking and reporting functionalities of Deploy.",
    tags: [
      'deploy-module',
      'application-update',
      'compliance-tracking',
  ...
  {
    question:
      'To meet regulatory compliance, you need to periodically review and analyze the access rights and permissions of users within your Tanium environment. Which module provides detailed reports on user permissions and access levels?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      "You're tasked with customizing the Tanium console dashboard to display critical security alerts and endpoint health statuses for quick review by your IT security team. Which module allows you to configure these dashboard widgets?",
    choices: [
      {
        id: 'a',
        text: 'Interact module for real-time querying',
  ...
  {
    question:
      'During a compliance audit, you need to export a monthly report of all deployed patches and vulnerabilities across your network. Which Tanium module will automate and schedule these compliance reports?',
    choices: [
      {
        id: 'a',
        text: 'Reporting module for scheduled reports',
  ...
  {
    question:
      'Your organization requires integration between Tanium and your ticketing system to automate incident response workflows. Which module should you configure to enable this capability?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'To manage user access and permissions for different Tanium modules effectively, which area of the Tanium Console should you navigate to?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "User Administration is correct because it is the dedicated area for managing user accounts, roles, and permissions, which includes access control for various Tanium modules. Choice A (Console Settings) is incorrect because it is for general console configurations, not specifically for user permissions. Choice B (Module Management) is incorrect because it focuses on managing the installation and configuration of modules, not user permissions. Choice D (Dashboard Customization) is incorrect because it pertains to the visual setup of the console's dashboard, not access control.",
    tags: ['user-administration', 'module-permissions-access', 'user-roles', 'access-control'],
    id: 'NAVIGA-GEN-1760820765699-4',
  },
  {
    question:
      'Your company aims to enhance its security posture by visualizing endpoint compliance trends over the past 6 months. Which module allows for the creation and analysis of this historical data?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      "After deploying a new security tool across your endpoints, you need to ensure it's installed and running on all systems. Which module would you use to quickly verify the deployment's success?",
    choices: [
      {
        id: 'a',
        text: 'Deploy module for managing software distributions',
  ...
  {
    question:
      'You need to configure Tanium to send real-time alerts to your security information and event management (SIEM) system whenever a new unmanaged device is detected on the network. Which module facilitates this direct integration?',
    choices: [
      {
        id: 'a',
        text: 'Connect module for data integration',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Connect is correct because it provides the capability to integrate Tanium data with external systems like SIEMs, enabling the automation of real-time alerts for new unmanaged devices. Choice B (Interact) is incorrect because, while it can query devices in real-time, it doesn't automate the sending of alerts to external systems. Choice C (Trends) is incorrect because it's for analyzing data trends within Tanium, not for external alerting. Choice D (Deploy) is incorrect because it's focused on managing endpoints, not on data integration or alerting.",
    tags: ['connect-module', 'siem-integration', 'real-time-alerts', 'unmanaged-device-detection'],
    id: 'NAVIGA-GEN-1760820765699-7',
  },
  {
    question:
      'In preparation for an upcoming security audit, you are tasked with generating a report showing all user logins to the Tanium platform over the last 90 days. Which module will you use to create and schedule this report?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'Your team is investigating a recent security breach and needs to quickly identify all endpoints that communicated with a known malicious IP address over the last week. Which Tanium module should you use to perform this investigation?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      'To enhance operational efficiency, you want to automate the distribution of monthly patch updates across all endpoints. Which module is most suited to manage and automate this task?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      "You've been tasked to create a dashboard showing the health status of all endpoints in your network. Which Tanium module allows you to customize such a dashboard for ongoing monitoring?",
    choices: [
      {
        id: 'a',
    ...
    tags: ['dashboard-customization', 'trends-module', 'endpoint-health', 'monitoring'],
    id: 'NAVIGA-GEN-1760820833633-1',
  },
  {
    question:
      'Your organization requires a scheduled report of all software installed on endpoints in the last month. Which Tanium module should you use to automate this task?',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    category: 'Practical Scenarios',
    explanation:
      "Reporting is correct because it has the capability to generate detailed reports on specific metrics, such as endpoint compliance, and schedule them for automatic delivery, including email summaries. Choice A (Trends) is incorrect because it focuses on visualizing data trends rather than generating and sending reports. Choice B (Interact) is incorrect because it's primarily used for real-time data querying, not scheduled reporting. Choice D (Connect) is incorrect because its main purpose is to export data to external systems, not create reports.",
    tags: ['reporting-module', 'compliance-reporting', 'scheduled-reports', 'email-summary'],
    id: 'NAVIGA-GEN-1760820833633-3',
  },
  {
    question:
      'You need to export Tanium data to a third-party analytics tool for further analysis. The export needs to include specific data points and occur on a daily basis. Which module allows you to configure and automate this data export?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Connect is correct because it is designed to integrate Tanium with external systems, allowing for the setup and automation of data exports based on specific criteria and schedules. Choice A (Deploy) is incorrect because Deploy is focused on executing actions on endpoints, not data export. Choice C (Trends) is incorrect because Trends is used primarily for internal data visualization, not for exporting data. Choice D (Interact) is incorrect because, although it can query specific data points, it doesn't automate the export process to external systems.",
    tags: ['connect-module', 'data-export', 'automation', 'third-party-integration'],
    id: 'NAVIGA-GEN-1760820833633-4',
  },
  {
    question:
      "After deploying a new software across the network, you want to ensure it's running correctly on all endpoints. Which Tanium module would you utilize to verify the software's operational status on each endpoint?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Interact is correct because it allows you to quickly query the operational status of installed software across all endpoints in real-time. Choice A (Deploy) is incorrect because Deploy is used for distributing software and actions, not for verifying operational status. Choice C (Asset) is incorrect because, although it provides an inventory, it doesn't offer real-time operational checks. Choice D (Connect) is incorrect because it's designed for data export, not for querying the current operational status of software.",
    tags: ['interact-module', 'real-time-status', 'software-verification', 'operational-checks'],
    id: 'NAVIGA-GEN-1760820833633-5',
  },
  {
    question:
      "You are configuring a new user's permissions in the Tanium Console and need to restrict their access to only viewing and creating reports. Which module's permissions should you specifically configure to accommodate this requirement?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Reporting is correct because it is the module that directly deals with the creation, viewing, and management of reports, aligning with the requirement to restrict the user's access to these specific functions. Choice A (Deploy) is incorrect because Deploy manages endpoint actions, not report viewing or creation. Choice B (Interact) is incorrect because it handles real-time queries and sensor management, not reporting. Choice D (Connect) is incorrect because it focuses on data export, not report generation or viewing.",
    tags: [
      'module-permissions',
      'reporting-module',
      'user-access-control',
  ...
  {
    question:
      'In preparation for an upcoming audit, you need to present historical data on endpoint compliance trends over the past year. Which Tanium module would be most appropriate for gathering and presenting this information?',
    choices: [
      {
        id: 'a',
    ...
    tags: ['trends-module', 'compliance-trends', 'historical-data', 'audit-preparation'],
    id: 'NAVIGA-GEN-1760820833633-7',
  },
  {
    question:
      'Your organization wishes to streamline the deployment of new security policies across all endpoints. Which Tanium module is best suited to implement and verify the deployment of these policies?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Deploy is correct because it allows for the direct execution of policies and actions across endpoints, making it ideal for implementing security policies. Choice B (Interact) is incorrect because, while it can query deployment status, it doesn't execute deployments. Choice C (Trends) is incorrect because it's more suited for visualizing data over time rather than implementing policies. Choice D (Connect) is incorrect because it's focused on exporting data, not on policy deployment.",
    tags: ['deploy-module', 'security-policies', 'policy-deployment', 'implementation'],
    id: 'NAVIGA-GEN-1760820833633-8',
  },
  {
    question:
      'To enhance operational efficiency, your team decides to customize the Tanium Console dashboard to include widgets that display critical alerts and endpoint compliance status. Which module allows for this level of dashboard customization?',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    category: 'Practical Scenarios',
    explanation:
      "Trends is correct because it allows users to create customizable dashboards that can visualize both historical and real-time data. Choice A (Interact) is incorrect because, while it can query real-time endpoint data, it does not offer dashboard customization. Choice C (Deploy) is incorrect because it's focused on executing actions like software updates, not data visualization. Choice D (Connect) is incorrect because its primary function is data export, not dashboard creation or customization.",
    tags: ['dashboard-customization', 'trends-module', 'real-time-data', 'data-visualization'],
    id: 'NAVIGA-GEN-1760820907988-1',
  },
  {
    question:
      'During a security audit, you need to generate a report showing all users with access to the Deploy module within the last 30 days. Which module should you use to schedule and generate this compliance report?',
    choices: [
      {
        id: 'a',
        text: 'Reporting module for creating scheduled reports',
  ...
  },
  {
    ...
    tags: ['connect-module', 'data-export', 'automated-export', 'third-party-integration'],
    id: 'NAVIGA-GEN-1760820907988-3',
  },
  {
    question:
      "You're tasked with reducing the manual effort required to check compliance across your endpoints. You want to set up a system where compliance data is automatically gathered and visualized over time. Which module will you primarily use?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Trends is correct because it allows for the automatic gathering and visualization of compliance data over time, aiding in trend analysis and reducing manual checks. Choice B (Interact) is incorrect because, while it can perform real-time compliance checks, it doesn't automatically visualize data trends. Choice C (Deploy) is incorrect because, although it can enforce compliance, it doesn't offer visualization over time. Choice D (Connect) is incorrect as it focuses on exporting data for external reporting, not on visualizing compliance trends.",
    tags: ['trends-module', 'data-visualization', 'compliance-checks', 'historical-data'],
    id: 'NAVIGA-GEN-1760820907988-4',
  },
  {
    question:
      'In preparation for an upcoming security audit, you need to review and adjust user permissions across various Tanium modules to ensure minimum necessary access. Which area of the Tanium Console should you navigate to?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Console settings and preferences is correct because it's where administrators can manage user roles and permissions across Tanium, ensuring compliance with the principle of least privilege. Choice A (Deploy) is incorrect because it's used for executing actions on endpoints, not for configuring user access. Choice C (Interact) is incorrect because, while it can query data across endpoints, it doesn't manage user permissions. Choice D (Connect) is incorrect because it's designed for data export configurations, not user permission settings.",
    tags: ['console-settings', 'user-roles', 'module-permissions', 'security-audit-preparation'],
    id: 'NAVIGA-GEN-1760820907988-5',
  },
  {
    question:
      "After deploying Tanium to a new region, you're tasked with setting up a dashboard that allows regional administrators to quickly view the health status of their endpoints, including patch levels and malware detections. Which module should you utilize to create a dashboard tailored for their specific needs?",
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    category: 'Practical Scenarios',
    explanation:
      "Reporting is correct because it enables the creation, scheduling, and automatic distribution of reports, making it ideal for monthly compliance notifications. Choice A (Connect) is incorrect because it focuses more on data export than on notifying about compliance statuses. Choice B (Deploy) is incorrect as it's used primarily for enforcing compliance, not for reporting on it. Choice D (Interact) is incorrect because it performs real-time checks, not automated monthly reporting.",
    tags: [
      'reporting-module',
  ...
  {
    question:
      'To enhance operational efficiency, your organization wants to analyze endpoint data alongside other IT management data within an external BI tool. This analysis requires daily exports of Tanium data. Which module is specifically designed to facilitate this integration?',
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Connect is correct because it provides the functionality to configure and automate the export of Tanium data to external systems, such as BI tools, on a scheduled basis. Choice A (Trends) is incorrect because it's primarily for internal data analysis and visualization. Choice C (Asset) is incorrect as it focuses on endpoint inventory, not data export. Choice D (Interact) is incorrect because it's used for querying data in real-time, not for setting up automated data exports.",
    tags: ['connect-module', 'data-export', 'external-integration', 'BI-tool-integration'],
    id: 'NAVIGA-GEN-1760820907988-8',
  },
  {
    question:
      'Your company has implemented Tanium for endpoint management and now requires a solution to keep track of historical endpoint activity for analysis. Which module offers the capability to view and analyze endpoint activity over time?',
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      "As a new Tanium administrator, you've been tasked with customizing the dashboard to display critical security alerts, system health, and compliance status across your network. Which Tanium module allows you to create and customize such dashboards for ongoing monitoring?",
    choices: [
      {
        id: 'a',
  ...
  {
    question:
      "Your organization requires a weekly report of all endpoint security tools' operational status to be emailed to the IT security team. Which Tanium module should you configure to automate the generation and distribution of this report?",
    choices: [
      {
        id: 'a',
    ...
    category: 'Practical Scenarios',
    explanation:
      "Reporting is correct because it allows for the creation, scheduling, and automatic distribution of reports, fitting the need for weekly updates to the IT security team. Choice A (Connect) is incorrect as it's primarily used for exporting data to external systems, not for creating scheduled reports. Choice C (Interact) is incorrect because, while it can query endpoint status, it doesn't support scheduling or automatic emailing of reports. Choice D (Trends) is incorrect as it visualizes historical data but does not automate report distribution.",
    tags: [
      'reporting-module',
      'scheduled-reports',
      'endpoint-security',
  ...
  {
    question:
      "During a routine compliance audit, it's identified that your organization needs to export endpoint compliance data to an external database daily for further analysis. Which Tanium module will you use to automate this data export process?",
    choices: [
      {
        id: 'a',
