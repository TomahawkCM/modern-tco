...
export const generatedFlashcards: CreateFlashcardLibraryCard[] = [
  ...
  {
    front: "Your manager needs a weekly report on patch compliance. Which Tanium feature helps you automate this?",
  ...
  {
    front: "You need to send question results to a colleague who doesn't have Tanium access. What's the best way?",
