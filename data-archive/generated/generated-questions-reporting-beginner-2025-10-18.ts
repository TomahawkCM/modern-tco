...
export const generatedQuestions: Question[] = [
  ...
  {
    "question": "A manager requests a weekly export of all installed software on company laptops in a format that can be easily manipulated for further analysis. What is the best method for accomplishing this task within Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to quickly identify and remedy non-compliant endpoints that violate your organization's security policies. These findings must be communicated to your IT service management (ITSM) system for ticketing. Which Tanium module facilitates the automatic sending of this compliance data to the ITSM system?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To comply with industry regulations, your company must archive all endpoint activity data for at least five years. Which Tanium module should you use to automate the archiving process, ensuring data is regularly exported and stored securely?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've been tasked with generating a weekly report on software installations across the enterprise to identify unauthorized applications. Which Tanium module should you utilize to automate and distribute this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "As a security analyst, you want to ensure that all incident response activities are logged and sent to your ITSM system for auditing purposes. Which Tanium module will you configure to achieve this integration?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to provide monthly compliance reports in a visual format for executive review. Which approach would best enable you to generate these reports within Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are configuring Tanium to send endpoint security data to a SIEM system for continuous monitoring. Which data export format should you select to ensure compatibility with most SIEM systems?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires an automated process to archive all Tanium reports older than one year for compliance purposes. Which solution would you implement to meet this requirement?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Configuring Connect destinations is correct because Connect can be used to automate the archiving of reports by setting up destinations that trigger archival actions based on the age of the reports, fulfilling compliance requirements. Choice B (Trends) is incorrect because Trends is designed for data visualization, not for data archiving. Choice C (Deploy) is incorrect because using Deploy to run custom scripts is not the most efficient way to automate report archiving. Choice D (Asset) is incorrect because, while it manages assets, it does not directly manage report archiving or data retention policies.",
    "tags": [
  ...
  {
    "question": "In preparation for an upcoming audit, you need to generate a report showing all users who have accessed sensitive data within the last 30 days. Which module would you use to create and distribute this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've noticed an increase in the number of requests for network access reports. To streamline this process, you decide to create a scheduled report that automatically emails a summary to the network team every Monday. Which Tanium module facilitates this process?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Connect is correct because it allows for the automation and scheduling of report generation and distribution, including emailing summaries at set intervals, such as weekly to the network team. Choice A (Interact) is incorrect because it requires manual intervention to generate reports. Choice C (Trends) is incorrect because it focuses on data visualization, not on the automation of report delivery. Choice D (Asset) is incorrect because it's used for asset tracking, not for scheduling and emailing reports.",
    "tags": [
      "scheduled-report",
      "connect-module",
      "report-automation",
  ...
  {
    "question": "To improve operational efficiency, your team wants to export endpoint health data into the company's dashboard tool for real-time monitoring. Which export format would you recommend for seamless integration?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "JSON is correct because it supports real-time data processing and seamless integration with most modern dashboard tools, facilitating efficient operational monitoring. Choice A (PDF) is incorrect because it is primarily for human-readable reports and not suitable for system integrations. Choice B (CSV) is incorrect because, while compatible with spreadsheets, it may not support the dynamic data structures required for real-time dashboard integration. Choice D (XML) is incorrect because, although it's structured, JSON is more commonly used for real-time data feeds due to its lightweight nature.",
    "tags": [
      "data-export-formats",
      "json-export",
  ...
  {
    "question": "To comply with new regulations, your company must ensure all endpoint security data is retained for at least five years. Which Tanium feature should you configure to meet this data retention requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "During a routine audit, it was discovered that your organization needs a better method of sharing critical security reports with external auditors without giving them direct system access. Which Tanium functionality would best facilitate this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A cybersecurity analyst at your organization wants to automate the process of exporting weekly Tanium threat intelligence reports to a JSON file for further analysis. Which Tanium module should they use to configure this scheduled export?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Connect is correct because it is designed to schedule and automate the export of data in various formats, including JSON, for integration with external systems or for further analysis. Choice A (Interact) is incorrect because it's primarily used for real-time queries, not for scheduling exports. Choice B (Trends) is incorrect because it focuses on visualizing data over time within Tanium, not exporting it. Choice D (Discover) is incorrect because its main function is to identify unmanaged assets within the network, not to export data.",
    "tags": [
      "connect-module",
      "data-export",
      "scheduled-reports",
  ...
  {
    "question": "You are tasked with sharing a daily report on newly detected malware across all endpoints with the IT security team. Which feature should you use to automate the distribution of this report via email?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To comply with industry regulations, your company needs to archive all endpoint activity data for at least five years. Which Tanium module would you use to automate the process of exporting and archiving this data?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Use Connect to export data to long-term storage is correct because Connect can automate the export of data in specific formats to designated external systems or locations, such as long-term archival storage solutions. Choice B (Configure Asset to track and store endpoint data) is incorrect because Asset is designed for asset inventory and does not handle data exporting or archiving. Choice C (Apply Trends to visualize and save historical data) is incorrect because Trends focuses on data visualization, not on data archiving. Choice D (Deploy module to create automated archival scripts) is incorrect because Deploy is intended for software distribution and configuration management, not data archiving.",
    "tags": [
      "connect-module",
      "data-archiving",
      "long-term-storage",
  ...
  {
    "question": "Your organization requires a detailed weekly report of all software installed on endpoints within a certain department, including the software version and installation date, to be exported in CSV format for compatibility with other tools. Which Tanium module facilitates this task?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Connect for scheduling and formatting exports is correct because it enables the automation of data export tasks and supports various formats, including CSV, which is required for compatibility with other tools. Choice A (Asset for endpoint inventory management) is incorrect because, while Asset can manage and view endpoint inventory, it doesn't directly support exporting data to CSV through automation. Choice C (Interact to query real-time endpoint data) is incorrect because Interact is primarily used for real-time data queries, not for scheduling exports. Choice D (Trends for data visualization and analysis) is incorrect because Trends focuses on the visualization of data over time and does not export data.",
    "tags": [
      "connect-module",
      "csv-export",
  ...
  {
    "question": "After a recent security audit, you're required to implement a solution to share real-time alerts on security incidents with your company's ITSM system. Which Tanium solution would you configure to meet this requirement?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Utilize Connect with a proper destination set for ITSM integration is correct because Connect allows for the configuration of data exports directly to external systems, like ITSM systems, facilitating real-time sharing of security incident alerts. Choice B (Apply the Alerts module to notify the security team directly) is incorrect because, while Alerts can notify users within Tanium, it doesn't support direct integration with external ITSM systems. Choice C (Configure Asset to continuously monitor and report security incidents) is incorrect because Asset is focused on asset inventory, not on real-time security alerts. Choice D (Use Trends to visualize and manually share incident data) is incorrect because Trends is for data visualization within Tanium and doesn't automate the sharing of alerts with external systems.",
    "tags": [
      "connect-destinations",
      "itsm-integration",
      "real-time-alerts",
  ...
  {
    "question": "The compliance team requires a monthly report of all non-compliant endpoints, detailing the specific compliance checks that failed. They need these reports to be automatically archived and easily accessible for audit purposes. Which configuration would best suit this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "For a project to analyze software usage across the enterprise, your team needs to export a list of all installed applications from Tanium, including usage statistics, in XML format for integration with a custom analytics tool. Which module and export format would you use?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team is implementing a new workflow to integrate endpoint vulnerability data from Tanium with a third-party risk management platform. The integration requires data to be sent in JSON format. Which Tanium feature should be configured for this continuous data feed?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for an upcoming security audit, your organization requires a detailed report of all administrative actions taken within the Tanium platform over the past year. This report needs to be shared with auditors in PDF format. Which module would you use to generate and share this report?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To streamline incident response, your security team wants to automatically update an incident management dashboard in real-time based on Tanium data. Which integration approach should you take to ensure seamless data flow into the dashboard?",
    "choices": [
      {
        "id": "a",
        "text": "Deploy a custom script using the Deploy module"
  ...
  {
    "question": "Your organization wants to automate the distribution of weekly endpoint health reports to department heads. Which feature should you use to schedule and email these reports directly?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Scheduled report automation in the Reports module is correct because it allows for the creation, scheduling, and distribution of reports, including email distribution. Choice A (Report templates in the Interact module) is incorrect because, while it helps create reports, it does not support scheduling or emailing. Choice B (Scheduled actions in the Deploy module) is incorrect because it's for executing actions, not distributing reports. Choice D (Connect destinations in the Connect module) is incorrect because it's primarily used for exporting data to external systems, not for scheduling and emailing reports.",
    "tags": [
      "scheduled-report-automation",
      "reports-module",
      "report-distribution",
  ...
  {
    "question": "You need to create a daily report showing all new software installed on endpoints within the last 24 hours. Which approach would best accomplish this using Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to export endpoint security state data to a third-party SIEM system for continuous monitoring. Which Tanium module should you configure to automate this data export?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with sharing weekly compliance reports with a team that does not have access to Tanium. What is the most efficient way to ensure they receive the reports automatically?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "During a quarterly review, your team decides to enhance security reporting by visualizing failed login attempts across the network. Which Tanium feature should you utilize to create this data visualization?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You want to ensure that the IT compliance and security teams receive immediate alerts when specific Tanium reports indicate non-compliance or security issues. Which solution is most appropriate?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After a recent security audit, you are required to archive all Tanium reports related to endpoint security for a minimum of five years. Which feature should you use to manage this long-term data retention?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're implementing Tanium for the first time and need to ensure operational data is shared with your ITSM platform for incident management. Which Tanium module facilitates the integration for this purpose?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To improve response times to critical vulnerabilities, your security team needs to visualize and analyze endpoint vulnerability data in real-time. Which Tanium module should you leverage for creating these real-time dashboards?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Utilizing the Trends module for data visualization is the correct choice because it allows for the creation of dynamic, real-time dashboards that can display endpoint vulnerability data, facilitating quick analysis and response. Choice B (Implement the Interact module for live queries) is incorrect because, while it can query real-time data, it doesn't specialize in data visualization. Choice C (Deploy the Protect module for vulnerability management) is incorrect because Protect focuses on managing and mitigating vulnerabilities rather than visualizing them. Choice D (Configure the Connect module for external analytics) is incorrect because Connect is utilized for exporting data to external systems and not for creating dashboards.",
    "tags": [
      "trends-module",
      "data-visualization",
  ...
  {
    "question": "Your company policies mandate that all exported reports from Tanium must be in a format that is easily readable and editable by non-technical staff. Which data export format should you primarily use?",
    "choices": [
      {
        "id": "a",
