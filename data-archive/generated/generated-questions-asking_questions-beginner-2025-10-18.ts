...
export const generatedQuestions: Question[] = [
  ...
  {
    "question": "Your company is preparing for an internal audit and needs to verify that all endpoints are running the latest operating system version to comply with IT security policies. You are assigned to find this information efficiently and accurately. What is the best way to proceed using Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with identifying which devices in your organization are running an outdated version of a critical software package. To accomplish this quickly, you decide to use Tanium. Which approach will provide you with the most efficient and accurate results?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization's compliance policy requires regular checks on the encryption status of all endpoints. You need to verify which devices are compliant. Which method in Tanium will help you gather this information most effectively?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "As part of a security audit, you need to quickly identify which endpoints are running a specific, vulnerable version of an application. You remember that Tanium can provide this information in real-time. How should you proceed to obtain accurate information efficiently?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "As a new IT administrator, you are tasked with verifying the installation status of a critical security application across all endpoints. Which approach would you take to quickly gather this information using Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team is planning a network upgrade and needs to ensure no critical security software will be incompatible after the change. Which step should you take first using Tanium to identify potentially affected software?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "During an audit, you need to demonstrate that all endpoints comply with a new security policy by having a specific firewall setting enabled. Which Tanium module and feature should you utilize to gather this compliance information?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A recent security breach investigation requires you to quickly identify all endpoints running an outdated version of a specific software. How would you use Tanium to find this information effectively?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to ensure that all laptops in your organization are running Windows 10 version 20H2 or newer for a compliance requirement. Which method would you choose to verify this using Tanium?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Choice B (Query the 'Operating System' sensor in the Interact module) is correct because it allows for precise and immediate querying of the operating system versions across all laptops. Choice A is incorrect because the Manage module's configuration policies are not designed for querying or reporting on OS versions. Choice C is incorrect as it is very time-consuming and not practical for quick verification across many devices. Choice D is incorrect because Trends is for analyzing data over time, not for querying specific, current data points.",
    "tags": [
      "Interact-module",
  ...
  {
    "question": "To improve network security, you've been tasked with finding all endpoints that haven't rebooted in the last 30 days. Which Tanium feature would best accomplish this task?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires a weekly report of all newly installed software across the enterprise to monitor for unauthorized applications. What is the most efficient way to use Tanium for this task?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After updating company-wide firewall settings, you need to verify that all devices are compliant with the new policy. Which Tanium capability should you leverage for this verification?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "While preparing for a major operating system upgrade across the company, you need to identify which endpoints are running an outdated OS version. How would you accomplish this using Tanium?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Choice B (Query the 'Operating System Version' sensor in the Interact module) is the most direct and efficient way to identify endpoints with outdated OS versions, providing real-time data across the enterprise. Choice A is incorrect because deploying a script does not identify or report on OS versions, it enforces a change. Choice C is incorrect as generating a report is less immediate and may not easily identify specific outdated versions. Choice D is incorrect because Trends focuses on data over time and is less suited for identifying specific, current operating system versions.",
    "tags": [
      "Interact-module",
      "Operating-System-Version-sensor",
      "OS-upgrade",
      "real-time-data"
    ],
  ...
  {
    "question": "To enhance endpoint security, you're tasked with ensuring all company devices have antivirus software installed. Which Tanium feature would best enable you to confirm the installation status across the network?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with identifying which endpoints are running Windows 10 within your network to plan an upgrade to Windows 11. Your objective is to get this information quickly and accurately. Which method should you use?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Asking a question in the Interact module using the 'Operating System' sensor is correct because it allows for real-time querying of endpoint operating systems, quickly identifying Windows 10 machines. Choice A (Deploy) is incorrect because it's used for executing actions, not for querying data. Choice B (Asset) is incorrect as it might not provide real-time data. Choice D (Trends) is incorrect because it visualizes data over time rather than providing an immediate list of endpoints.",
    "tags": [
      "interact-module",
      "operating-system-sensor",
      "windows-upgrade",
  ...
  {
    "question": "During a compliance audit, you need to verify if all desktops in your organization have a specific application installed. How can you efficiently gather this information using Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're investigating a potential security breach and need to quickly determine the last logged-in user on all endpoints in a specific subnet. Which approach will provide you with the fastest results?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Asking a question using the 'Last Logged In User' sensor in the Interact module is correct because it provides real-time information on user logins across endpoints, which is crucial for a swift security investigation. Choice A (Trends) is incorrect because it's focused on historical data analysis. Choice B (Deploy) is incorrect as it involves action execution rather than direct querying. Choice D (Connect) is incorrect because it's meant for exporting data to external systems, not for immediate querying.",
    "tags": [
      "interact-module",
  ...
  {
    "question": "Your IT department wants to improve the efficiency of identifying outdated software on endpoints to mitigate vulnerabilities. What is the most effective way to achieve this using Tanium?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Using the 'Installed Applications' sensor in the Interact module for real-time data is correct because it allows the IT department to quickly identify and address vulnerabilities by knowing which software versions are installed. Choice A (Deploy) is incorrect as its main function is to execute actions, not for data querying. Choice C (Trends) is incorrect because it visualizes historical data, which might not reflect the current software status. Choice D (Connect) is incorrect because it focuses on data export for external analysis, not immediate action.",
    "tags": [
      "interact-module",
  ...
  {
    "question": "The network team has reported intermittent connectivity issues on several endpoints. They need to know the current IP addresses of these machines for troubleshooting. How should you proceed to assist them?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization has deployed a new security policy requiring all PCs to run antivirus software. How can you best verify compliance across all endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for a network upgrade, you need to assess the current operating system versions on all endpoints. Which approach offers the most efficient path to this information?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Following a directive to ensure all laptops are encrypted, you need to determine which ones need attention. How can you identify laptops without encryption using Tanium?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Asking a question in the Interact module with a custom sensor for encryption status is correct because it directly queries the encryption status in real-time, enabling quick identification of non-compliant laptops. Choice A (Connect) is incorrect because it's designed for data export, not live status checks. Choice C (Trends) is incorrect due to its focus on visualizing historical data. Choice D (Deploy) is incorrect because it pertains to executing actions, not querying current statuses.",
    "tags": [
      "interact-module",
      "encryption-status",
      "security-compliance",
  ...
  {
    "question": "The compliance team needs to verify if all endpoints have the latest internal security tool installed. Which method allows you to quickly gather this information?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've been asked to help improve network security by identifying endpoints with an outdated operating system. What's the most direct way to find this information?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with verifying that all laptops in the organization are running Windows 10 or newer. Which approach would yield the most accurate results?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A critical vulnerability has been announced, and you need to find out which endpoints have a specific application installed to assess your exposure. What is the best way to quickly gather this information?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Asking a question in the Interact module using the 'Installed Applications' sensor is the most efficient method to get real-time data on application installations across endpoints. Choice A (Deploy) is incorrect because it executes actions rather than queries. Choice B (Asset) provides comprehensive inventory data but may not be as real-time or targeted as required. Choice D (Trends) is incorrect because it's designed for visualizing data over time, not for immediate querying.",
    "tags": [
      "Interact-module",
      "installed-applications",
  ...
  {
    "question": "During a security audit, you're asked to provide a list of all endpoints with their respective IP addresses and operating system versions. Which feature should you use to efficiently gather this data?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to optimize a frequently asked question in Tanium to reduce its response time and load on the network. What best practice should you follow?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Best Practices",
    "explanation": "Narrowing the scope of the question using more specific sensor parameters is the best practice to optimize performance, as it reduces the amount of data being processed and transmitted. Choice A (Increase timeout settings) might allow more time for responses but does not reduce the load. Choice C (Ask during off-peak hours) could reduce network congestion but doesn't improve the question's efficiency. Choice D (Save with a broad scope) would likely increase the response time and load, contrary to the goal of optimization.",
    "tags": [
  ...
  {
    "question": "Your team is planning to upgrade all computers within the organization to the latest operating system version. To prepare, you need to identify which computers are currently running an outdated version. Which sensor should you use in Tanium to find this information quickly?",
    "choices": [
      {
        "id": "a",
        "text": "Computer Model"
  ...
  {
    "question": "You have been asked to ensure that all endpoints are compliant with a new security policy which requires a specific configuration in the firewall settings. Which approach would you use in Tanium to verify compliance across all endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A recent security breach investigation requires you to quickly identify all endpoints that accessed a specific malicious domain over the last 30 days. Which Tanium module will provide you with the fastest access to this information?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Querying endpoints in real-time with the Interact module is the most effective way to identify recent access to a specific domain, as it allows for direct, ad-hoc questioning of endpoint activities. Choice A (Trends) is useful for analyzing patterns over time but may not offer the immediate, detailed insight required. Choice C (Trace) provides detailed forensic data, which could be relevant but is not the most direct method for this query. Choice D (Connect) is focused on exporting data rather than querying endpoint activities.",
    "tags": [
      "Interact-module",
      "real-time-query",
      "security-breach",
  ...
  {
    "question": "After deploying a new software, you need to confirm it has been installed across all targeted endpoints. Which Tanium feature should you use to verify the software installation?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to gather information on the last time each endpoint received an update. Which sensor in Tanium would provide this information most effectively?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "The 'Last Update Time' sensor in Tanium directly provides the information required to understand when each endpoint last received an update, making it the most effective choice. Choice A (Last User Login) indicates when a user last logged in, not when the system was updated. Choice B (Operating System Build) could show the OS version but not the specific time of the last update. Choice D (BIOS Version) gives BIOS information, which is unrelated to software updates.",
    "tags": [
      "Interact-module",
      "last-update-time",
      "system-updates",
  ...
  {
    "question": "To streamline your operational tasks, you're interested in automating the process of checking for unauthorized software installations weekly. What is the best approach for setting up this automated check in Tanium?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Best Practices",
    "explanation": "Creating a recurring saved question in the Interact module for the 'Installed Applications' sensor is the best approach to automatically check for unauthorized software installations on a weekly basis. This method directly queries endpoint data for real-time accuracy and automation. Choice A (Deploy) is more about response action rather than proactive querying. Choice C (Asset) could track installations but doesn't offer the same level of automation for specific checks. Choice D (Trends) is useful for observing patterns over time but lacks the specificity for automated checks on unauthorized installations.",
    "tags": [
      "Interact-module",
      "automated-checks",
  ...
  {
    "question": "You're tasked with identifying outdated software on all employee laptops to mitigate security risks. Which Tanium module and feature should you use to gather this information efficiently?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To improve incident response times, you need to quickly identify which endpoints are running a specific, vulnerable version of an application. What is the best approach using Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You receive a directive to verify the operating system versions across the organization to ensure they meet the latest compliance standards. Which Tanium feature would you utilize to accomplish this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After a security breach, you need to find all endpoints that have SSH enabled. Which approach will yield the fastest and most accurate results?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are planning to enhance your network's security by identifying all devices that lack the latest antivirus version. Which sensor in Interact would you primarily use for this purpose?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to audit the use of administrative privileges across the network. Which sensor would you utilize in Interact to identify users logged in with admin rights?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've been asked to ensure all endpoints are running Windows 10 version 1903 or later. Which sensor query in Interact will accurately return this information?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for a company-wide audit, you need to collect data on all installed software and hardware configurations across endpoints. Which Tanium feature should you use for a comprehensive overview?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your company is transitioning to remote work and needs to ensure all remote employees have encrypted hard drives. What is the most direct way to verify this using Tanium?",
    "choices": [
      {
        "id": "a",
