...
export const generatedQuestions: Question[] = [
  {
    "question": "You're tasked with deploying a new security tool across all endpoints. The tool's installer requires specific configuration parameters for each department. How should you deploy this package to ensure correct configuration?",
    "choices": [
      {
        "id": "a",
    ...
    "explanation": "Utilizing package parameters and deploying a customizable package is correct because it allows you to specify different configurations for the security tool based on departmental needs in a scalable manner. Choice A is incorrect because hardcoding parameters lacks the flexibility needed for department-specific configurations. Choice B is incorrect due to the unnecessary overhead of maintaining multiple packages. Choice C is incorrect as manual configuration is not scalable or efficient for large numbers of endpoints.",
    "tags": [
  ...
  {
    "question": "A critical update needs to be applied outside of business hours to avoid disrupting users. How should you schedule this action in Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After deploying a package to update a software across the network, you notice it caused issues on several endpoints. What is the most efficient way to address this situation?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Using the rollback feature in Tanium to undo the action is the most efficient way to address this situation because it allows you to quickly revert changes on affected endpoints without manually uninstalling software or deploying another package. Choice A is not scalable or efficient. Choice B creates additional workload and may not address individual endpoint issues. Choice D is not a proactive approach to resolving the immediate issues.",
    "tags": [
  ...
  {
    "question": "Your team needs to regularly deploy a custom script to monitor endpoint health, but wants to minimize administrative overhead. What is the best approach to achieve this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To enhance security, your organization decides to regularly change local administrator passwords on all endpoints. Which Tanium package deployment feature should you leverage to accomplish this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A department has requested the installation of custom software that requires approval each time before deployment. Which configuration should you use to manage this requirement in Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "During a routine check, you discover a package deployed to several endpoints did not execute as expected due to incorrect parameters. What is your immediate next step to correct this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires that all deployed actions be monitored for execution status and results. What is the best practice in Tanium for achieving this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To ensure compliance, you need to deploy a security configuration update monthly. Which feature should you use to automate this process in Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are planning to deploy a new software package across the organization. To minimize disruptions, you need to ensure the software is only installed outside of business hours. However, your organization operates in multiple time zones. How should you configure the deployment?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Beginner",
    "category": "Practical Scenarios",
    "explanation": "Using Tanium's action scheduling to target endpoints based on local time zones is correct because it allows you to automate the deployment process while ensuring installations occur during off-hours in each time zone, minimizing disruptions. Choice A is inefficient and prone to error. Choice C does not guarantee the installation will happen outside of business hours. Choice D offloads responsibility to end-users, leading to potential non-compliance and varied installation times.",
    "tags": [
      "action-scheduling",
  ...
  {
    "question": "You're planning to deploy a new software package to all endpoints within your organization. The deployment must occur outside of business hours to minimize impact on user productivity. Which feature should you use to schedule this deployment?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After deploying a package to update a critical application across multiple endpoints, you notice that the application fails to start on several machines. Which action should you take first to mitigate this issue?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team needs to deploy a security patch to address a new vulnerability. The patch must only be applied to affected endpoints running a specific version of an operating system. Which approach should you take to ensure accurate targeting?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A critical update needs to be deployed immediately during business hours. However, your organization requires that all actions must be approved by the IT security team before execution. Which feature can ensure timely deployment while adhering to this policy?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've deployed a new security tool across the network, but you need to verify its installation status on all endpoints. Which Tanium module allows you to monitor the action execution progress in real-time?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for a software audit, you need to ensure that all devices in your network are running the latest version of a specific software. There's a package in the Tanium library that updates the software. Before deploying, what should you do first to minimize disruptions?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After deploying a custom package to your endpoints, you realize that a critical mistake was made in the package configuration, potentially harming the system performance. Which recovery procedure should you immediately initiate?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A recent update to an essential business application has caused compatibility issues on several endpoints. You need to remove this update quickly. Which Tanium feature allows you to reverse the action on specific endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You have been tasked with deploying a security configuration across all laptops in the organization. The deployment must only target laptops that are currently online to ensure immediate compliance. Which approach should you use to accurately target these devices?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires that all deployed packages must be reviewed and approved by two separate departments before execution. Which Tanium feature should you configure to comply with this internal policy?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've been tasked with deploying a new software package to all endpoints within your organization. However, you must ensure that deployment only occurs outside of business hours to prevent disruption. Which feature should you use to schedule the deployment?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A critical update needs to be rolled back from a group of endpoints due to unexpected issues. What is the first step you should take to initiate the rollback process?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "While preparing to deploy a critical security update, you notice the package requires specific configuration parameters for different endpoint groups. How can you ensure the correct parameters are used for each deployment?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team has developed a new internal tool that needs to be rapidly deployed across all endpoints. You need to monitor the execution of this action closely to ensure success. Which Tanium feature should you use to monitor the action execution?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A package deployment to a remote office failed due to network issues, and you need to ensure it is executed again once the network is stable. What is the most efficient way to set up this deployment?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires that all deployed actions must be approved by a senior IT administrator to ensure compliance with internal policies. Which Tanium feature enables this workflow?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After deploying a package, you realize it was configured incorrectly for a subset of endpoints, causing performance issues. What is the best immediate action to mitigate the impact while you prepare a corrected package?",
    "choices": [
      {
        "id": "a",
        "text": "Use the Revert feature in the Deploy module"
  ...
  {
    "question": "You are preparing to deploy a new version of an application across your organization. To minimize risk, you decide to deploy the package to a small group of test endpoints first. Which Tanium feature should you use to accomplish this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've noticed that certain critical actions are delayed due to the approval process, which affects your organization's security posture. What Tanium feature can you use to expedite the deployment of these critical actions?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Before deploying a complex new software package, you need to ensure it doesn’t adversely affect endpoint performance across your network. What strategy should you employ using Tanium to ensure the package is safe and performance-friendly?",
    "choices": [
      {
        "id": "a",
