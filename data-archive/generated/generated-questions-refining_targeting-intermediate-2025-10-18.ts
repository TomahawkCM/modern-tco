...
export const generatedQuestions: Question[] = [
  {
    "question": "Your organization requires a dynamic computer group for all devices not running the latest version of your antivirus software. This group will be used to target updates. Which filter logic should you use to create this group?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with optimizing query performance for a recurring check that targets endpoints in specific geographic locations. Which approach should you use to minimize impact on the network?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "An IT administrator needs to apply a critical update to endpoints running a specific version of an application vulnerable to a recent exploit. However, the administrator wants to exclude servers to prevent potential service disruption. Which method should be used to accurately target these endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your team must ensure compliance reports only include data from endpoints within the EU to adhere to GDPR requirements. Which scoping method should be used to configure this within Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In response to a detected malware outbreak, you need to quickly identify all endpoints that have not run a full antivirus scan in the past 7 days. Which Tanium feature should you use to target these endpoints for immediate scanning?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your company's security policy requires that all endpoints in the finance department are part of a dedicated computer group for specific security policies. The membership of this group changes frequently. What is the most efficient way to manage this group?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "After deploying a new application across your network, you need to verify its installation on a specific set of endpoints defined by their role in the organization. Which Tanium feature allows for the most precise targeting of these endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To improve network security posture, you decide to segment endpoints into groups based on operating system versions. This strategy is to prioritize patching efforts. Which type of computer group is most suitable for this task?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to enforce stricter security policies on endpoints used by the executive team. You decide to create a dedicated computer group for these devices. What is the most effective method to ensure this group accurately reflects the current executive team's endpoint usage?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Following a security breach, you must identify all endpoints with a specific vulnerable software version installed. The list of affected endpoints changes daily. Which method provides the most efficient ongoing identification of these endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're configuring a new dynamic computer group to identify endpoints that haven't reported back in over 24 hours. Which filter criteria should you use to ensure accurate targeting?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "During a security audit, you need to quickly identify all endpoints running Windows 10 version 1809 that haven't been patched in the last 90 days. What's the most efficient way to filter your query?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with deploying a new software only to laptops within your organization. How do you best target these endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A new regulation requires all endpoints within certain departments to have specific security software installed. How would you ensure compliance using Tanium?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Creating dynamic groups based on department and software presence allows for precise targeting and automated compliance checks by identifying endpoints within specific departments that lack the required software. Choice A (manually checking) is inefficient and error-prone. Choice B (using RBAC) manages user access but doesn't ensure software installation. Choice D (global deployment) may not meet department-specific requirements.",
    "tags": [
      "dynamic-computer-groups",
      "RBAC",
      "security-compliance",
  ...
  {
    "question": "To optimize performance when targeting a large set of endpoints for a critical update, what filter optimization technique should you apply?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "When setting up a new content set for a team that only manages mobile devices, what scoping strategy ensures they only interact with relevant endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires a hierarchy of computer groups to manage endpoints by geographic region, OS type, and department. What is the first step in creating an effective group structure?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "For an upcoming audit, you need to ensure all endpoints in the Finance department are part of a specific computer group. What approach allows for the most efficient management of group membership?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To minimize network impact while targeting endpoints for a large-scale software deployment across multiple departments, which targeting strategy should you employ?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are tasked with ensuring that only endpoints in the HR department can access a sensitive HR management tool. You need to dynamically group these endpoints for targeted management. Which approach should you use to create this group?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Dynamic computer group based on department attribute is correct because it allows the group to update automatically as endpoints change or new HR endpoints are added, ensuring that all relevant devices are targeted without manual intervention. Choice A is incorrect because static groups do not update automatically, requiring manual adjustments. Choice C is incorrect because manual assignment isn't practical for dynamic environments and doesn't leverage Tanium's capabilities. Choice D is incorrect as RBAC controls user access within Tanium, not endpoint access to specific tools.",
    "tags": [
      "dynamic-computer-groups",
      "RBAC",
      "targeting-specific-endpoints",
  ...
  {
    "question": "A cybersecurity analyst needs to apply a critical patch to all endpoints running a specific version of an application vulnerable to a recent exploit. Which approach ensures only the affected endpoints are targeted for the patch?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires that only IT administrators have the ability to execute actions on endpoints within the IT department. Which Tanium feature should you configure to meet this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're optimizing Tanium for performance and need to ensure that questions run efficiently across thousands of endpoints. Which technique should you primarily focus on to improve question performance?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Best Practices",
    "explanation": "Using boolean logic in filters to refine question results is correct because it enables more precise targeting of endpoints, reducing the amount of data processed and consequently improving question performance. Choice A is partially correct but limiting questions to only pre-collected sensor data might not always be feasible for real-time needs. Choice C is incorrect as increasing the frequency of question collections could actually degrade performance by adding load to the network and endpoints. Choice D is incorrect because deploying additional modules increases system demands, potentially worsening performance instead of improving it.",
    "tags": [
      "filter-performance-optimization",
  ...
  {
    "question": "During a compliance audit, you need to identify endpoints that do not have the required security software installed. To automate this process for future audits, which type of computer group should you create?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To minimize network impact, you've been asked to target a software deployment to only those laptops within the sales department that do not already have the software installed. What is the best way to configure this targeting in Tanium?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to ensure that only endpoints running Windows 10 or newer are included in a computer group for a Windows 10-specific configuration policy. Which approach will effectively automate this membership?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "A dynamic computer group with a filter for the operating system version is correct because it allows for the automatic update of group membership based on the operating system criteria, ensuring that only compatible endpoints are targeted. Choice A is not practical as it requires constant manual updates. Choice C is labor-intensive and inefficient for large deployments. Choice D confuses user groups with computer groups; the requirement is to target endpoints, not users, based on the operating system.",
    "tags": [
      "dynamic-computer-groups",
      "operating-system-version",
  ...
  {
    "question": "Your company is deploying Tanium to a new geography and must ensure endpoints in this region can only be managed by local administrators. What is the most effective way to configure this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for a security audit, you need to quickly identify all endpoints that have not run a full antivirus scan within the last 7 days. Which approach will best achieve this?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "To support regulatory compliance, you must ensure that only endpoints with encrypted hard drives are allowed network access to sensitive financial systems. How can you best configure Tanium to continuously enforce this policy?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You are configuring a new dynamic computer group in Tanium to include only Windows 10 endpoints that have not reported in the last 24 hours. What filter combination will accurately target the desired endpoints?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "As part of an audit, you're tasked with identifying endpoints running unauthorized software. You decide to create a computer group for ongoing monitoring. Which approach ensures the group dynamically updates as new endpoints meet the criteria?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're tasked with deploying a critical update to all endpoints, but you need to exclude servers due to their unique environment. Which targeting strategy in Tanium should you use to accurately deploy the update?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Choice B is correct because using a dynamic group that excludes endpoints with 'Server' in their operating system name allows for precise targeting while dynamically updating as endpoints join or leave the criteria. Choice A is incorrect because manually excluding servers is error-prone and inefficient. Choice C is incorrect because retracting actions is not a recommended deployment strategy due to potential inconsistencies and timing issues. Choice D is incorrect because a static group does not dynamically update, potentially missing new desktop endpoints or including outdated ones.",
    "tags": [
      "targeting-specific-endpoints",
      "dynamic-groups",
  ...
  {
    "question": "Your organization requires deploying a security tool only to laptops. To accomplish this, you need to create a computer group for laptops using Tanium. Which attribute should primarily be used to distinguish laptops from desktops?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You need to optimize a Tanium question that targets endpoints requiring a specific patch. The initial question takes too long to return results due to the large number of endpoints. Which strategy would most effectively optimize the filter performance?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Choice B is correct because using boolean logic to combine filters efficiently can significantly reduce the number of evaluated endpoints and speed up query response times. Choice A is incorrect because increasing the client cache size may affect local resource usage but does not directly optimize the performance of filtering in questions. Choice C is incorrect because targeting all endpoints and manually filtering results post-query is inefficient and does not leverage Tanium's capabilities to refine targeting. Choice D is incorrect because while asking questions during off-peak hours may reduce network load, it does not optimize the filter's performance or decrease the time to return results.",
    "tags": [
      "filter-performance-optimization",
      "boolean-logic-filters",
      "advanced-filtering-techniques",
  ...
  {
    "question": "After a security incident, you are tasked with identifying endpoints that accessed a specific malicious domain. You decide to use Tanium to query endpoints for DNS query logs. To minimize performance impact, what filter should you apply to narrow down the search?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You've been asked to ensure that only members of the IT department can view and manage endpoints within the IT subnet. Which Tanium feature should you employ to achieve this requirement?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "A recent policy change requires that all finance department computers must have a specific security software installed. To enforce this policy, you need to regularly identify finance computers lacking the software. Which Tanium feature should you utilize to automate this process?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "In preparation for a compliance audit, you need to ensure that only devices compliant with corporate security standards can access sensitive data. Which approach allows you to dynamically manage access based on compliance status?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "You're implementing a policy to automatically isolate endpoints detected with a known vulnerability until they are patched. What Tanium feature should you utilize to automate the isolation of vulnerable endpoints?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Choice C is correct because using a dynamic group that automatically includes endpoints detected with a known vulnerability enables the triggering of isolation policies for those endpoints without manual intervention. Choice A is incorrect because a static group requires manual updating and does not facilitate automatic isolation. Choice B is incorrect because employing RBAC to limit network access based on user roles does not directly correlate with the dynamic nature of vulnerabilities on endpoints. Choice D is incorrect because content set scoping limits access to Tanium content and does not directly enable the isolation of vulnerable endpoints.",
    "tags": [
      "dynamic-computer-groups",
  ...
  {
    "question": "You are tasked with ensuring only devices within the marketing department receive a new software deployment. To accurately target these devices, you decide to create a computer group. Considering the dynamic nature of the department's device roster, which type of computer group should you create?",
    "choices": [
      {
        "id": "a",
  ...
  {
    "question": "Your organization requires a weekly report on endpoints missing critical security updates. To optimize performance, you need to create a saved question targeting only Windows machines with a specific vulnerability. Which of the following filter clauses should you use to refine your targeting?",
    "choices": [
      {
        "id": "a",
    ...
    "difficulty": "Intermediate",
    "category": "Practical Scenarios",
    "explanation": "Choice A is correct because it precisely targets Windows machines that match a specific vulnerability by using 'contains' and 'equals', which are both efficient and accurate filter types for this scenario. Choice B is incorrect as the 'OR' operator would broaden the target unnecessarily, potentially including non-Windows devices or devices without the specific vulnerability. Choice C is incorrect because the 'not equals' operator would exclude the relevant vulnerability, and regex could be less efficient. Choice D is incorrect as it targets Linux machines, not Windows.",
    "tags": [
      "advanced-filtering-techniques",
      "boolean-logic-in-filters",
      "filter-performance-optimization"
  ...
  {
    "question": "As part of a new security directive, you need to ensure that only senior IT administrators can modify the configurations of Tanium's core modules. Which Tanium feature should you configure to enforce this requirement?",
    "choices": [
      {
        "id": "a",
