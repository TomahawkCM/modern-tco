...
export const generatedFlashcards: CreateFlashcardLibraryCard[] = [
  ...
  {
    front: "You're building a multi-sensor question in Interact and it keeps timing out. What's the most likely fix?",
  ...
  {
    front: "You want to turn a useful Interact question into ongoing monitoring in Trends. What's the workflow?",
  ...
  {
    front: "Your boss needs a compliance report showing patch status for the last 6 months. Which modules do you use and in what order?",
  ...
  {
    front: "How do you set up Tanium to automatically send security events to your SIEM using Connect?",
  ...
  {
    front: "What's the main benefit of using Connect for data export instead of manual CSV exports?",
  ...
  {
    front: "You need to investigate a security incident, monitor it for 30 days, and send weekly reports to your boss. Which modules and in what order?",
