...
const MODULES = [
  {
    ...
    objective: "Get comfortable with sensors, Get/From clauses, and live vs cached results.",
    ...
    reflection: "Which sensors responded fastest, and when would you rely on cached results?",
  },
  {
    id: "m2",
    title: "Module 2 — Question Builder",
    objective: "Design valid questions visually: dropdowns, parameters, AND/OR logic.",
    ...
    labs: [
      ...
      },
      {
        ...
        steps: ["Add Uptime (days) to the grid to spot long-running systems."],
      },
      {
        id: "m2-l4",
        title: "Save 'Bluebeam Audit — Windows'",
        steps: ["Save question → give a descriptive name for reuse."],
      },
      {
        id: "m2-l5",
        title: "Preview before Ask",
        steps: ["Use the Builder Preview to validate syntax and scope."],
      },
      {
        id: "m2-l6",
      ...
      },
      {
        ...
        steps: ["Switch to text entry and compare.", "Decide when you’d prefer builder vs manual."],
      },
      {
        id: "m2-l8",
        title: "Template library",
        steps: ["Save as template; standardize naming for your team."],
      },
      {
        id: "m2-l9",
        title: "Windows 11 subset",
        steps: ["Modify the saved question to target only Windows 11 endpoints."],
      },
      {
        id: "m2-l10",
        title: "Compare runs",
        steps: ["Run templates side-by-side and document differences."],
      },
    ],
    reflection: "How does the Builder help you avoid syntax errors, and when is manual faster?",
  },
  {
    id: "m3",
    title: "Module 3 — Refining Questions & Targeting",
    objective: "Narrow results safely and preview targets before taking action.",
    examTag: "TCO Domain 2.1 — Refining & Targeting",
    labs: [
      {
        id: "m3-l1",
        title: "Re-run 'Bluebeam Audit — Windows'",
        steps: ["Open the results grid and review freshness + counts."],
      },
      {
        id: "m3-l2",
        title: "Filter to Windows 11",
        steps: ["Grid filter: Operating System contains 'Windows 11'."],
      },
      {
        id: "m3-l3",
        title: "Prefix filter",
        steps: ["Add Computer Name starts with 'EDM' (or your site code)."],
      },
      {
        id: "m3-l4",
      ...
      },
      {
        id: "m3-l5",
        title: "Dynamic group",
        steps: ["Save refined results as dynamic group: 'Win11 — Bluebeam'."],
      },
      {
        id: "m3-l6",
        title: "Uptime threshold",
        steps: ["Ask: Get Uptime (days) → refine to > 7 days."],
      },
      {
        id: "m3-l7",
        title: "Static vs dynamic",
        steps: ["Compare behavior after endpoints change state."],
      },
      {
        id: "m3-l8",
        title: "Preview before execute",
        steps: ["Always use Show Preview; record what you’d verify."],
      },
      {
        id: "m3-l9",
        title: "Risk reflection",
        steps: ["List risks if refinement is skipped; add mitigations."],
      },
      {
        id: "m3-l10",
        title: "Export refined results",
        steps: ["Export grid to CSV for audit or follow-up action."],
      },
    ],
    reflection: "Which refinements most reduced risk before action deployment?",
  },
  // Volume 2
  {
    id: "m4",
    title: "Module 4 — Scenario Practice",
    objective: "End-to-end workflows mirroring TCO scenarios.",
    examTag: "TCO Domains 2.2–3.2",
    labs: [
      {
        id: "m4-l1",
        title: "Audit Bluebeam on Windows 11",
        steps: ["Combine sensors + refine + export."],
      },
      { id: "m4-l2", title: "Uptime > 7 days subset", steps: ["Filter numerics; compare runs."] },
      {
        id: "m4-l3",
        title: "Outdated OS builds",
        steps: ["Identify and document remediation set."],
      },
      {
        id: "m4-l4",
        title: "Saved dynamic group",
        steps: ["Create, verify auto-update behavior."],
      },
      {
        id: "m4-l5",
        title: "Live vs cached comparison",
        steps: ["Time-separated reruns; note deltas."],
      },
      ...
      { id: "m4-l9", title: "Report-ready export", steps: ["CSV discipline + naming."] },
      {
        ...
        steps: ["Summarize, include screenshots."],
      },
    ],
  ...
  },
  {
    ...
    labs: [
      {
        id: "m5-l1",
        title: "Firewall state compliance",
        steps: ["Get Windows Firewall State → equals 'On'."],
      },
      {
        id: "m5-l2",
        title: "Hardware audit trio",
        steps: ["Chassis Type, Memory Size, Manufacturer."],
      },
      { id: "m5-l3", title: "Regex naming rule", steps: ["Computer Name matches ^EDM.*11$."] },
      {
        id: "m5-l4",
        title: "AV vs Firewall cross-check",
        steps: ["Compare two security sensors."],
      },
      {
        id: "m5-l5",
        title: "Version threshold",
        steps: ["Installed Applications contains Bluebeam; version < 21."],
      },
      {
        id: "m5-l6",
        title: "Offline patterns",
        steps: ["Use Sensor Status to spot systemic issues."],
      },
      { id: "m5-l7", title: "Target subnet", steps: ["Filter IP Address within 10.10.155.*"] },
      {
        id: "m5-l8",
        title: "Compound filter",
        steps: ["OS contains Windows AND Uptime > 10 AND Office present."],
      },
      {
        id: "m5-l9",
        title: "Saved question: High Uptime Windows",
        steps: ["Create, rerun, document."],
      },
      {
        id: "m5-l10",
        title: "Dynamic refresh validation",
        steps: ["Confirm results change over 24h."],
      },
    ],
  ...
  },
  {
    ...
    quiz: {
      items: [
        ...
        {
          q: "Two benefits of Saved Questions?",
          a: "Reusability and dashboard/report integration.",
        },
      ],
    },
...
// ======= Components =======
function Sidebar({ current, onSelect, progress }) {
  ...
  return (
    <aside className="w-full shrink-0 space-y-4 border-r border-gray-200 p-4 dark:border-gray-800 md:w-72">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold">Tanium Interact Labs</h1>
        <span className="rounded bg-gray-100 px-2 py-1 text-sm dark:bg-gray-800">{percent}%</span>
      </div>
        ...
        {MODULES.map((m) => (
          <button
            ...
            className={classNames(
              "w-full rounded px-3 py-2 text-left transition focus:outline-none focus:ring",
              current === m.id
...
function ExportImport({ progress }) {
  const download = () => {
  ...
  return (
    <div className="space-y-2 rounded border border-gray-200 p-3 dark:border-gray-800">
      ...
      <div className="flex gap-2">
        ...
        <label className="cursor-pointer rounded bg-gray-100 px-3 py-1 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700">
          Import
...
function LabCard({ lab, completed, onToggle, notes, onNoteChange }) {
  const [open, setOpen] = useState(false);
  return (
    <div className="overflow-hidden rounded-md border border-gray-200 dark:border-gray-800">
      <button
        className="flex w-full items-center gap-3 bg-gray-50 px-4 py-3 text-left hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800"
      ...
      {open && (
        <div className="space-y-3 p-4">
          ...
          <div className="space-y-1">
            ...
            <textarea
              className="min-h-[100px] w-full rounded border border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-900"
              value={notes || ""}
      ...
      <ol className="ml-5 list-decimal space-y-3">
        {items.map((it, i) => (
          <li key={i}>
            ...
            {revealed && <div className="mt-1 text-sm opacity-80">Answer: {it.a}</div>}
          </li>
        ))}
      </ol>
    </section>
...
export default function App() {
  ...
  const filteredLabs = useMemo(() => {
    ...
    return labs.filter(
      (l) => l.title.toLowerCase().includes(q) || l.steps.join(" ").toLowerCase().includes(q)
    );
  }, [current, query]);
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 dark:bg-black dark:text-gray-100">
      <header className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white/80 px-4 py-3 backdrop-blur dark:border-gray-800 dark:bg-black/80 print:hidden">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs opacity-80">
              Professional Workbook • Created for Rob Neveu – Edmonton, AB
            </div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <input
            ...
            className="rounded border border-gray-200 bg-white px-3 py-1 dark:border-gray-800 dark:bg-gray-900"
      ...
      <main className="mx-auto grid max-w-7xl gap-0 md:grid-cols-[18rem_1fr]">
        ...
        <section className="space-y-6 p-4">
                ...
                {filteredLabs.map((lab) => (
                  <LabCard
                    ...
                    onToggle={() =>
                      setProgress((p) => ({
                        ...p,
                        completed: { ...p.completed, [lab.id]: !p.completed[lab.id] },
                      }))
                    }
          ...
          {current.reflection && (
            <div className="space-y-2">
              ...
              <textarea
                className="min-h-[120px] w-full rounded border border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-900"
                placeholder="Write your self-assessment or next steps…"
                value={progress.notes[`${current.id}-reflection`] || ""}
                onChange={(e) =>
                  setProgress((p) => ({
                    ...p,
                    notes: { ...p.notes, [`${current.id}-reflection`]: e.target.value },
                  }))
                }
              />
            </div>
          ...
          <footer className="border-t border-gray-200 pt-6 text-xs opacity-70 dark:border-gray-800">
            Tanium Interact Study Lab Companion (TCO Exam Prep) — Professional Training Web App • ©{" "}
            {new Date().getFullYear()} • For personal study use.
          </footer>
        </section>
      </main>
