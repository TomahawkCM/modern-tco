...
Notes:
- The Module 00 v2 page now uses `ModuleRendererLite`, which removes heavy analytics/session providers and dynamically loads practice/quiz components. This dropped LCP from 1.79s to 1.53s and keeps TBT at 0ms.
