...
import { encryptData, decryptData, parseBudgetFile } from "@/lib/export/import-budget";
import type { BudgetFile, BudgetExportData, EncryptedDataPayload } from "@/lib/export/types";
...
describe("parseBudgetFile", () => {
  ...
  it("should throw for missing data", () => {
    expect(() => parseBudgetFile('{"metadata": {"version": "1.0.0"}}')).toThrow(
