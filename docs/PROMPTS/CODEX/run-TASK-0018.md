# Codex Session — TASK-0018: Playwright e2e smoke
...
## Steps
1) Read the task file: `docs/TASKS/TASK-0018.md` and implement acceptance criteria.
...
## Commit
`feat(TASK-0018): Playwright e2e smoke`
