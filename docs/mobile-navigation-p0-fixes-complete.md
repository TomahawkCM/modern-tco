...
<Link
  href="/budget-app"
  className="flex flex-col items-center gap-1 px-4 py-2 text-gray-600 hover:text-teal-500 transition-colors min-w-[64px] min-h-[48px] rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
  aria-label="Dashboard"
>
  <Home className="w-6 h-6" />
  <span className="text-xs font-medium">Home</span>
