...
<TooltipProvider delayDuration={300}>
  <Tooltip>
    ...
    <TooltipContent side="top" className="max-w-xs">
      <p className="text-sm leading-relaxed">Your tooltip content here</p>
      <a href="/docs/user-guide#topic" className="mt-2 block text-xs text-teal-600 hover:underline">
        Learn more →
      </a>
    </TooltipContent>
  </Tooltip>
...
<div className="contextual-help-panel">
  ...
  <div className="prose prose-sm max-w-none">
    <p>
      Amortization shows how your loan payment splits between principal (the amount you borrowed)
      and interest (the cost to borrow).
    </p>
    ...
    <p>
      Notice how more of your payment goes toward principal over time. This is why extra payments
      early in the loan save so much interest!
    </p>
  </div>
