# Budget App - User Documentation

Welcome to the Budget App user guide! This documentation will help you get the most out of your personal finance management.
...
[Read more about privacy →](./01-faq.md#data--privacy)
...
**Install as PWA for best experience!** [How to install →](./01-faq.md#is-there-a-mobile-app)
...
[See full roadmap →](./01-faq.md#what-features-are-coming-soon)
...
- **Export data**: Download to Excel/Sheets for analysis
...
- 🔄 Financial Tips & Best Practices (in progress)
...
[Join the community →](https://github.com/budget-app)
