...
async function testImport() {
  ...
  console.log(`   ${merchantSaved ? '✅' : '❌'} Merchant save: ${merchantSaved ? 'SUCCESS' : 'FAILED'}\n`);
  ...
  console.log(`   ${patternSaved ? '✅' : '❌'} Pattern save: ${patternSaved ? 'SUCCESS' : 'FAILED'}\n`);
  ...
  if (categoryResult) {
    ...
    console.log(`      - Category: ${categoryResult.category} / ${categoryResult.subcategory || 'N/A'}`);
  ...
  console.log(`   Merchant Learning:     ${merchantSaved ? '✅' : '❌'} ${merchantSaved ? 'Working' : 'Failed'}`);
  console.log(`   Category Learning:     ${patternSaved ? '✅' : '❌'} ${patternSaved ? 'Working' : 'Failed'}`);
  console.log(`   Database Verification: ${merchantResult ? '✅' : '❌'} ${merchantResult ? 'Working' : 'Failed'}`);
  console.log('\n═══════════════════════════════════════════════════════\n');
