...
const sampleFlashcards: SampleFlashcard[] = [
  // Asking Questions Domain
  {
    ...
    back_text:
      'A Tanium Sensor is a predefined or custom data collector that retrieves specific information from endpoints, such as system properties, installed software, or running processes.',
    card_type: 'concept',
    source: 'manual',
    explanation:
      'Sensors are the foundation of Tanium questions - they define WHAT data to retrieve from endpoints.',
  ...
  },
  {
    ...
    back_text:
      "Use the 'Save Question' button in the Question Results panel, give it a descriptive name, and optionally assign it to a group. Saved questions can be accessed from the 'Saved Questions' menu.",
    card_type: 'basic',
    source: 'manual',
  ...
  },
  {
    ...
    back_text:
      "'Get' initiates a question to retrieve data from endpoints. It's followed by the sensor name, e.g., 'Get Computer Name' or 'Get Installed Applications'.",
    card_type: 'concept',
    source: 'manual',
  ...
  // Refining Questions & Targeting
  {
    ...
    back_text:
      'A Computer Group is a saved filter that defines a collection of endpoints based on specific criteria (e.g., Operating System, IP Range, or custom sensors). It allows targeted question deployment.',
    card_type: 'concept',
    source: 'manual',
    explanation:
      'Computer Groups are essential for RBAC and efficient targeting of specific endpoint subsets.',
  ...
  },
  {
    ...
    back_text:
      "Add a filter using 'where Operating System contains <value>' or select the OS filter from the filter dropdown in the Question Builder.",
    card_type: 'basic',
    source: 'manual',
  ...
  },
  {
    ...
    back_text:
      "'From all machines' targets every endpoint the Tanium server knows about. 'From <computer group>' targets only endpoints matching the group's filter criteria, reducing scope and improving performance.",
    card_type: 'concept',
    source: 'manual',
  ...
  // Taking Action
  {
    ...
    back_text:
      'A Package is a deployable unit containing commands, scripts, or files that execute actions on endpoints (e.g., install software, apply patches, or run diagnostics).',
    card_type: 'concept',
    source: 'manual',
    explanation:
      "Packages are the 'action' component of Tanium - they define WHAT to do on endpoints.",
  ...
  },
  {
    ...
    back_text:
      'Check the Action Status dashboard to view deployment progress, success/failure counts, and detailed results per endpoint. You can also ask a question to verify the expected state change.',
    card_type: 'basic',
    source: 'manual',
  ...
  // Navigation & Basic Modules
  {
    ...
    back_text:
      'Interact is the primary interface for asking real-time questions and viewing endpoint data. It allows live interrogation of the infrastructure with sub-second response times.',
    card_type: 'concept',
    source: 'manual',
  ...
  },
  {
    ...
    back_text:
      'Historical data is stored in the Trends module, which records question results over time for trending analysis and compliance reporting.',
    card_type: 'basic',
    source: 'manual',
  ...
  // Reporting & Data Export
  {
    ...
    back_text:
      'Tanium supports multiple export formats including CSV, JSON, XML, and can integrate with SIEM/SOAR platforms via REST API. Reports can also be scheduled for automated delivery.',
    card_type: 'basic',
    source: 'manual',
  ...
  },
  {
    ...
    back_text:
      'In the Reporting module, save a report configuration, then set up a schedule with desired frequency (daily, weekly, etc.), recipients, and delivery method (email or API endpoint).',
    card_type: 'basic',
    source: 'manual',
