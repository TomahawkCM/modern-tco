...
const askingQuestionsData: Omit<DatabaseQuestion, "id">[] = [
  {
    question:
      "Which Tanium console function is used to create and execute queries across all managed endpoints?",
    options: [
    ...
    correct_answer: 1,
    explanation:
      "The Question bar in the Tanium console is the primary interface for creating and executing queries across managed endpoints to gather real-time data.",
    difficulty: "beginner",
  ...
  },
  {
    ...
    correct_answer: 2,
    explanation:
      "The default timeout for Tanium questions is 120 seconds (2 minutes), though this can be configured by administrators based on environment requirements.",
  ...
  },
  {
    ...
    correct_answer: 1,
    explanation:
      "The 'Operating System' sensor provides detailed information about the OS version, build, and architecture on managed endpoints.",
    difficulty: "beginner",
    category: "Platform Fundamentals",
  ...
  {
    question:
      "How do you save a frequently used question for future reference in the Tanium console?",
    options: [
    ...
    correct_answer: 0,
    explanation:
      "The 'Save Question' option allows you to save frequently used queries for quick access and reuse, improving operational efficiency.",
    difficulty: "intermediate",
    category: "Console Procedures",
  ...
  {
    question:
      "What syntax is used to query multiple sensors simultaneously in a single Tanium question?",
    options: [
    ...
    correct_answer: 1,
    explanation:
      "The 'and' operator is used to combine multiple sensors in a single Tanium question, allowing you to collect related data points in one query.",
    difficulty: "intermediate",
    category: "Console Procedures",
  ...
  // Continue with more asking questions...
  {
    ...
    correct_answer: 3,
    explanation:
      "Tanium sensors support String, Numeric, and Boolean parameter types, but do not natively support Array parameter types.",
    difficulty: "advanced",
    category: "Platform Fundamentals",
...
const refiningTargetingData: Omit<DatabaseQuestion, "id">[] = [
  {
    ...
    correct_answer: 1,
    explanation:
      "Computer Groups are used to define and target specific sets of endpoints for questions, actions, and deployments based on various criteria.",
    difficulty: "beginner",
    category: "Platform Fundamentals",
  ...
  {
    question:
      "How do you create a dynamic Computer Group that automatically updates based on system properties?",
    options: [
    ...
    correct_answer: 1,
    explanation:
      "Dynamic Computer Groups use sensor-based filters to automatically include or exclude endpoints based on real-time system properties and conditions.",
    difficulty: "intermediate",
    category: "Console Procedures",
  ...
  {
    question:
      "Which filter operator would you use to find endpoints with a specific registry value?",
    options: [
      { id: "a", text: "contains" },
      { id: "b", text: "equals" },
      { id: "c", text: "matches" },
    ...
    correct_answer: 1,
    explanation:
      "The 'equals' operator is used for exact matches when filtering for specific registry values or other discrete data points.",
    difficulty: "intermediate",
    category: "Console Procedures",
...
const takingActionData: Omit<DatabaseQuestion, "id">[] = [
  {
    ...
    options: [
      {
        id: "a",
        text: "Select package → Choose targets → Configure parameters → Deploy → Monitor",
      },
      {
        id: "b",
        text: "Configure parameters → Select package → Deploy → Monitor → Choose targets",
      },
      {
        id: "c",
        text: "Choose targets → Select package → Deploy → Configure parameters → Monitor",
      },
      {
        id: "d",
        text: "Monitor → Select package → Configure parameters → Choose targets → Deploy",
      },
    ],
    correct_answer: 0,
    explanation:
      "The correct deployment sequence ensures proper package selection, targeting, configuration, deployment, and monitoring for successful execution.",
    difficulty: "intermediate",
    category: "Console Procedures",
  ...
  {
    question:
      "How can you validate that a package deployment completed successfully across all targeted endpoints?",
    options: [
    ...
    correct_answer: 0,
    explanation:
      "Action History provides real-time visibility into deployment status, showing completion rates, errors, and individual endpoint results.",
    difficulty: "intermediate",
    category: "Console Procedures",
...
const navigationModulesData: Omit<DatabaseQuestion, "id">[] = [
  {
    ...
    correct_answer: 2,
    explanation:
      "Threat Response module provides security capabilities including threat hunting, incident response, and endpoint detection and response (EDR) functionality.",
    difficulty: "beginner",
    category: "Platform Fundamentals",
  ...
  },
  {
    ...
    correct_answer: 0,
    explanation:
      "The hamburger menu icon (three horizontal lines) in the top-left corner of the console provides access to all available Tanium modules.",
    difficulty: "beginner",
    category: "Console Procedures",
...
const reportingExportData: Omit<DatabaseQuestion, "id">[] = [
  {
    question:
      "Which export format provides the most flexibility for data analysis in external tools?",
    options: [
      { id: "a", text: "PDF" },
      { id: "b", text: "CSV" },
      { id: "c", text: "XML" },
    ...
    correct_answer: 1,
    explanation:
      "CSV format provides the most flexibility for importing Tanium data into spreadsheet applications, databases, and analysis tools for further processing.",
    difficulty: "beginner",
    category: "Platform Fundamentals",
  ...
  },
  {
    ...
    correct_answer: 1,
    explanation:
      "Saved questions can be configured with scheduling options to automatically generate and distribute reports at specified intervals.",
    difficulty: "intermediate",
    category: "Console Procedures",
...
async function seedQuestions() {
  try {
    ...
    for (let i = 0; i < questions.length; i += batchSize) {
      ...
      console.log(
        `⬆️  Inserting batch ${Math.floor(i / batchSize) + 1}/${Math.ceil(questions.length / batchSize)}...`
      );
